...
class ReplenishmentServiceImplTest {
     ...
     */
    @Mock
    private com.positivity.inventory.internal.replenishment.service.ReplenishmentSourcingService
            replenishmentSourcingService;
    ...
    void defaultForecastEqualsOnHand() {
        ...
        Mockito.lenient()
                ...
                .thenAnswer(
                        invocation -> new com.positivity.inventory.internal.replenishment.service
                                .ReplenishmentSourcingService.SourcingResolution(
                                com.positivity.inventory.internal.replenishment.service.ReplenishmentSourcingService
                                        .Kind.MATERIALIZE_TASK,
                                invocation
