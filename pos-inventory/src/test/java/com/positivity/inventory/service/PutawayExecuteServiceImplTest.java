...
class PutawayExecuteServiceImplTest {
    ...
    void setUp() {
        ...
        request = new PutawayExecutionRequest("sku-abc", sourceLocationId, destinationLocationId, 10);
    ...
    void executePutaway_throwsTaskNotFoundException() {
        ...
        assertThrows(
                TaskNotFoundException.class, () -> putawayExecuteService.executePutaway(taskId.toString(), request));
    }
    ...
    void executePutaway_throwsIllegalArgumentExceptionForInvalidUUID() {
        assertThrows(
                IllegalArgumentException.class, () -> putawayExecuteService.executePutaway("invalid-uuid", request));
    }
