...
class PickListServiceImplTest {
    ...
    void SC1_createPickList_validRequest_returnsDraftWithWorkorderId() {
        ...
        CreatePickListRequest request = new CreatePickListRequest(
                workorderId,
    ...
    void SC2_createPickList_validRequest_createsPickTasksWithPendingStatusAndSortOrder() {
        ...
        CreatePickListRequest request =
                new CreatePickListRequest(workorderId, Instant.now(TEST_CLOCK).plusSeconds(3600), 1, reservationId);
    ...
    @Test
    @DisplayName(
            "SC3_createPickList_nullWorkorderId: null workorderId → NullPointerException or IllegalArgumentException")
    ...
    void SC7_updatePickListStatus_draftToReadyToPick_returnsUpdatedResponse() {
        ...
        when(pickListRepository.save(any(PickListEntity.class))).thenAnswer(invocation -> invocation.getArgument(0));
    ...
    void PS2_confirmPickTask_validScan_returnsPickedTaskResponse() {
        ...
        PickTaskResponse result =
                service.confirmPickTask(pickListId, pickTaskId, productId, locationId, quantityRequired);
    ...
    void PS3_confirmPickTask_wrongSkuId_throwsPickScanMismatchException() {
        ...
        assertThatThrownBy(() -> service.confirmPickTask(pickListId, pickTaskId, wrongScannedSkuId, locationId, 1))
    ...
    void PS4_confirmPickTask_quantityExceedsRequired_throwsIllegalArgumentException() {
        ...
        // Act + Assert — BLOCKED: confirmPickTask does not exist on PickListServiceImpl
        assertThatThrownBy(
                        () -> service.confirmPickTask(pickListId, pickTaskId, productId, locationId, overPickQuantity))
    ...
    void PS5_confirmPickTask_lastPendingTask_triggersPickListCompleted() {
        ...
        // Act — BLOCKED: confirmPickTask does not exist on PickListServiceImpl
        PickTaskResponse result = service.confirmPickTask(pickListId, taskId2, productId, locationId, 1);
