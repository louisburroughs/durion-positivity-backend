...
class ReceivingServiceImplTest {
        ...
        void receiveItemsIntoStaging_exactQuantity_returnsLinesProcessedAndEmptyVariances() {
                ...
                ReceivingLine receivingLine = ReceivingLine.builder().lineId(lineId)
        ...
        void receiveItemsIntoStaging_sessionNotFound_throwsNotFoundException() {
                ...
                ReceiveLineRequest line = new ReceiveLineRequest(
                                UUID.fromString("00000000-0000-0000-0000-000000000001"), new BigDecimal("5"));
                ReceiveItemsRequest request = new ReceiveItemsRequest(List.of(line));
        ...
        void receiveItemsIntoStaging_unknownLineId_isSkippedGracefully() {
                ...
                ReceivingLine knownLine = ReceivingLine.builder().lineId(knownLineId)
                                .expectedQuantity(new BigDecimal("10"))
                                .build();
                ReceivingSession session = ReceivingSession.builder().sessionId(sessionId).lines(List.of(knownLine))
                                .build();
                when(receivingSessionRepository.findById(sessionId)).thenReturn(Optional.of(session));
        ...
        void receiveItemsIntoStaging_ledgerEntryUsesSiteDefaultStagingLocationWhenConfigured() {
                ...
                when(inventoryLedgerEntryRepository.save(any())).thenAnswer(inv -> inv.getArgument(0));
                when(inventoryLedgerEntryRepository.calculateOnHandQuantityAtLocation("PROD-001",
                                siteDefaultStagingLocationId))
                                .thenReturn(7);
        ...
        void crossDockLineToWorkorder_fullQuantity_returnsCrossDockResponse() {
                ...
                when(workorderValidationClient.getWorkorderLineValidation("WO-001", workorderLineId.toString()))
                                .thenReturn(new WorkorderValidationClient.WorkorderLineValidation("WORK_IN_PROGRESS",
                                                "PROD-001"));
        ...
        void crossDockLineToWorkorder_accumulatesReceivedQuantity() {
                ...
                CrossDockResponse result = receivingService.crossDockLineToWorkorder(sessionId, lineId, request,
                                "actor-user");
        ...
        void crossDockLineToWorkorder_exceedsExpectedQuantity_throwsAndDoesNotCreateLedgerEntries() {
                ...
                IllegalArgumentException exception = assertThrows(
                                ...
                                () -> receivingService.crossDockLineToWorkorder(sessionId, lineId, request,
                                                "actor-user"));
        ...
        void crossDockLineToWorkorder_sessionNotFound_throwsNotFoundException() {
                ...
                CrossDockRequest request = new CrossDockRequest("WO-001",
