...
class ReservationServiceImplTest {
        ...
        void setUp() {
                ...
                lenient().when(allocationRepository.findById(any(UUID.class))).thenAnswer(inv -> {
                        ...
                        return Optional.of(AllocationEntity.builder()
                                        ...
                                        .allocationState(AllocationState.SOFT).status(AllocationStatus.ALLOCATED)
                                        .build());
                });
         ...
         */
        @Test
        @DisplayName("SC1_createSoftReservation: valid SKU + quantity → PENDING status, SOFT allocation, allocatedQuantity set")
        void SC1_createSoftReservation_validSkuAndQuantity_returnsPendingWithSoftAllocation() {
                ...
                CreateReservationRequest request = new CreateReservationRequest(workorderLineId, "SKU-001", 5);
        ...
        void SC2_idempotencyByWorkorderLineId_duplicateWorkorderLineId_upserts() {
                ...
                // Arrange
                UUID workorderLineId = UUID.randomUUID();
                CreateReservationRequest first = new CreateReservationRequest(workorderLineId, "SKU-001", 5);
                CreateReservationRequest second = new CreateReservationRequest(workorderLineId, "SKU-001", 10);
         ...
         */
        @Test
        @DisplayName("SC7_quantityUpdate: existing PENDING reservation → update requiredQuantity → reservation updated, allocations adjusted")
        void SC7_quantityUpdate_existingPendingReservation_updatesQuantityAndAllocations() {
                ...
                // Arrange
                UUID workorderLineId = UUID.randomUUID();
                CreateReservationRequest original = new CreateReservationRequest(workorderLineId, "SKU-001", 3);
                CreateReservationRequest update = new CreateReservationRequest(workorderLineId, "SKU-001", 7);
        ...
        void createOrUpdateReservation_repositoryMode_existingReservation_updatesRequiredQuantity() {
                ...
                ReservationResponse response = repositoryService.createOrUpdateReservation(
                                new CreateReservationRequest(workorderLineId, "SKU-101", 9));
        ...
        void createOrUpdateReservation_repositoryMode_missingReservation_createsSoftAllocation() {
                ...
                ReservationResponse response = repositoryService.createOrUpdateReservation(
                                new CreateReservationRequest(workorderLineId, "SKU-NEW", 4));
        ...
        void promoteToHard_repositoryMode_insufficientAtp_setsBackorderedAndThrows() {
                ...
                when(inventoryLedgerEntryRepository.calculateOnHandQuantity("SKU-ATP")).thenReturn(2);
        ...
        void promoteToHard_repositoryMode_sufficientAtp_transitionsToHard() {
                ...
                when(allocationRepository.findById(allocation.getAllocationId())).thenReturn(Optional.of(allocation));
                when(inventoryLedgerEntryRepository.calculateOnHandQuantity("SKU-HARD")).thenReturn(10);
                when(allocationRepository.findByReservationAndAllocationState(reservation, AllocationState.HARD))
                                .thenReturn(List.of());
                ...
                ReservationResponse response = repositoryService.promoteToHard(
                                allocation.getAllocationId(),
                                new PromoteAllocationRequest("approved"));
        ...
        void promoteToHard_repositoryMode_currentHardAllocation_excludesSelfFromExistingHard() {
                ...
                when(inventoryLedgerEntryRepository.calculateOnHandQuantity("SKU-BRANCH")).thenReturn(6);
                when(allocationRepository.findByReservationAndAllocationState(reservation, AllocationState.HARD))
        ...
        void cancelReservation_repositoryMode_releasesSoftAndHardAllocations() {
                ...
                when(allocationRepository.findByReservation(reservation))
                                .thenReturn(List.of(softAllocation, hardAllocation));
