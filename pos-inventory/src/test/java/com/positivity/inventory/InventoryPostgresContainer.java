 ...
 * {@link com.positivity.inventory.tenancy.PostgresTenancyTestBase} and the {@code @DataJpaTest}
 * {@link PostgresSliceTestBase} — and the repository already pays for one copy of this bootstrap
 * too many.
 *
 * <p>Requires Docker.
 */
public final class InventoryPostgresContainer {
    ...
    private InventoryPostgresContainer() {}
    ...
    /** The database the container serves, for grants that name it. */
