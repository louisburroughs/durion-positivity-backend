...
class ContractBehaviorIT extends BaseContractIntegrationTest {
    ...
    void setUp() {
        inventoryPayload = createInventoryPayload(
                "00000000-0000-0000-0000-000000000001", "10000000-0000-0000-0000-000000000001", 100, 20, 80);
    }
    ...
    void testCreateInventoryAvailability_HappyPath() throws Exception {
        String payload = createInventoryPayload(
                "00000000-0000-0000-0000-000000000002", "10000000-0000-0000-0000-000000000002", 50, 10, 40);

        mockMvc.perform(authenticated(
                        post("/v1/inventory/availability/{productId}", "00000000-0000-0000-0000-000000000002")
    ...
    void testGetInventoryAvailability_HappyPath() throws Exception {
        mockMvc.perform(authenticated(
                        get("/v1/inventory/availability/{productId}", "00000000-0000-0000-0000-000000000001")
    ...
    void testCreateInventory_MissingProductId() throws Exception {
        String invalidPayload =
                "{\"locationId\":\"10000000-0000-0000-0000-000000000001\",\"onHandQty\":100,\"allocatedQty\":20}";

        mockMvc.perform(authenticated(
                        post("/v1/inventory/availability/{productId}", "00000000-0000-0000-0000-000000000001")
                                .contentType(MediaType.APPLICATION_JSON)
    ...
    void testCreateInventory_NegativeQuantity() throws Exception {
        String invalidPayload = createInventoryPayload(
                "00000000-0000-0000-0000-000000000003", "10000000-0000-0000-0000-000000000003", -5, 0, -5);

        mockMvc.perform(authenticated(
                        post("/v1/inventory/availability/{productId}", "00000000-0000-0000-0000-000000000003")
                                .contentType(MediaType.APPLICATION_JSON)
                                .content(invalidPayload)
    ...
    void testCreateInventory_AllocatedGreaterThanOnHand() throws Exception {
        String invalidPayload = createInventoryPayload(
                "00000000-0000-0000-0000-000000000004", "10000000-0000-0000-0000-000000000004", 30, 50, -20);

        mockMvc.perform(authenticated(
                        post("/v1/inventory/availability/{productId}", "00000000-0000-0000-0000-000000000004")
                                .contentType(MediaType.APPLICATION_JSON)
                                .content(invalidPayload)
    ...
    void testCreateInventory_Idempotent() throws Exception {
        ...
        String payload = createInventoryPayload(
                "00000000-0000-0000-0000-000000000005", "10000000-0000-0000-0000-000000000005", 75, 15, 60);

        mockMvc.perform(authenticated(
                        post("/v1/inventory/availability/{productId}", "00000000-0000-0000-0000-000000000005")
                                .contentType(MediaType.APPLICATION_JSON)
                                .content(payload)
    ...
    void testInventory_ATPInvariant() throws Exception {
        String payload = createInventoryPayload(
                "00000000-0000-0000-0000-000000000006", "10000000-0000-0000-0000-000000000006", 100, 30, 70);

        mockMvc.perform(authenticated(
                        post("/v1/inventory/availability/{productId}", "00000000-0000-0000-0000-000000000006")
                                .contentType(MediaType.APPLICATION_JSON)
                                .content(payload)
    ...
    void testInventory_ValidUOMEnum() throws Exception {
        String payload = createInventoryPayloadWithUom(
                "00000000-0000-0000-0000-000000000007", "10000000-0000-0000-0000-000000000007", 60, 10, "EACH");

        mockMvc.perform(authenticated(
                        post("/v1/inventory/availability/{productId}", "00000000-0000-0000-0000-000000000007")
                                .contentType(MediaType.APPLICATION_JSON)
                                .content(payload)
    ...
    private String createInventoryPayload(
            String productId, String locationId, int onHandQty, int allocatedQty, int expectedAtp) {
    ...
    private String createInventoryPayloadWithUom(
            String productId, String locationId, int onHandQty, int allocatedQty, String uom) {
        return String.format(
