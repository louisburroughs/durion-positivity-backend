...
class ContractBehaviorIT {
    ...
    void testInventory_TimestampFormat() throws Exception {
        ...
        String responseBody = result.getResponse().getContentAsString();
        String createdAt = objectMapper.readTree(responseBody).get("createdAt").asText();
    ...
    void testInventory_ValidUOMEnum() throws Exception {
        ...
        String responseBody = result.getResponse().getContentAsString();
        String uom = objectMapper.readTree(responseBody).get("uom").asText();
    ...
    private String createInventoryPayloadWithUom(String productId, String locationId, int onHandQty, int allocatedQty,
            String uom) {
        return String.format(
