...
class ReallocationContractBehaviorIT extends BaseContractIntegrationTest {
    ...
    @Test
    @DisplayName(
            "POST /v1/inventory/allocations/reallocate → response contains auditRecordsCreated > 0 when reallocation occurred")
    ...
    @Test
    @DisplayName(
            "POST /v1/inventory/allocations/reallocate → response serialises totalReallocated and atpAfterReallocation correctly")
