...
class CycleCountAdjustmentContractBehaviorIT extends BaseContractIntegrationTest {
    ...
    void createAdjustment_belowAllThresholds_returns201WithAutoApprovedStatus() throws Exception {
        ...
        String body =
                buildCreateRequestBody(UUID.fromString("00000000-0000-0000-0000-000000000001"), 101, 100, "10.00");
    ...
    void createAdjustment_exceedsThreshold_returns201WithPendingApprovalStatus() throws Exception {
        ...
        String body =
                buildCreateRequestBody(UUID.fromString("00000000-0000-0000-0000-000000000001"), 102, 100, "10.00");
    ...
    void approveAdjustment_pendingApproval_returns200WithPostedStatusAndApproverId() throws Exception {
        seedLowThreshold();
        UUID adjustmentId = createPendingApprovalAdjustment(UUID.fromString("00000000-0000-0000-0000-000000000001"));

        // Issue #26: approverUserId field is accepted, but actor is sourced from
        // authenticated security context (X-User).
        String approveBody = objectMapper.writeValueAsString(objectMapper
                .createObjectNode()
    ...
    void rejectAdjustment_pendingApproval_returns200WithRejectedStatusAndReason() throws Exception {
        ...
        String rejectBody = objectMapper.writeValueAsString(objectMapper
                .createObjectNode()
                .put("rejectorUserId", "manager-1")
                .put("rejectionReason", "Incorrect count"));

        mockMvc.perform(withGatewayAuth(post("/v1/inventory/cycleCountAdjustments/{adjustmentId}/reject", adjustmentId))
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(rejectBody))
                .andExpect(status().isOk())
    ...
    void createAdjustment_zeroVariance_returns400() throws Exception {
        ...
        String body =
                buildCreateRequestBody(UUID.fromString("00000000-0000-0000-0000-000000000001"), 100, 100, "10.00");
    ...
    void getAdjustment_existingId_returns200WithMatchingAdjustmentId() throws Exception {
        seedHighThreshold();
        UUID adjustmentId = createAutoApprovedAdjustment(UUID.fromString("00000000-0000-0000-0000-000000000001"));
    ...
    void listAdjustments_pendingStatus_returns200WithAtLeast2Items() throws Exception {
        ...
        mockMvc.perform(withGatewayAuth(
                        get("/v1/inventory/cycleCountAdjustments").param("status", "PENDING_APPROVAL")))
                .andExpect(status().isOk())
     ...
     */
    private String buildCreateRequestBody(UUID stockItemId, int countedQuantity, int quantityOnHandBefore, String cost)
            throws Exception {
