...
class PutawayExecutionContractBehaviorIT extends BaseContractIntegrationTest {
    ...
    @Test
    @DisplayName(
            "AC1: execute putaway with valid request returns 200 with COMPLETED status and PUTAWAY transaction type")
    void executePutaway_validRequest_returns200WithCompletedResponse() throws Exception {
        ...
        String requestBody =
                buildExecutionRequestBody(skuId, sourceLocationId.toString(), destinationLocationId.toString(), 5);
    ...
    void executePutaway_invalidDestinationForSku_returns422WithLocationNotValidErrorCode() throws Exception {
        ...
        String requestBody =
                buildExecutionRequestBody(skuId, sourceLocationId.toString(), destinationLocationId.toString(), 3);
    ...
    void executePutaway_sourceLocationZeroOnHand_returns422WithNoOnHandErrorCode() throws Exception {
        ...
        String requestBody =
                buildExecutionRequestBody(skuId, sourceLocationId.toString(), destinationLocationId.toString(), 2);
    ...
    private String buildExecutionRequestBody(
            String skuId, String sourceLocationId, String destinationLocationId, int quantity) throws Exception {
