 ...
 * 
 * <p>Implements the business rules defined in clarification #229 for issue #31:
 * <ul>
...
public interface PutawayValidationService {
     ...
     * @throws LocationNotValidForSkuException if location is invalid and no override
     */
     ...
     * 
     * <p>Default behavior: Block if at or exceeding capacity.
     * <p>Override allowed only if:
     * <ul>
     ...
     * 
     * <p>Default behavior: Always block if zero on-hand.
     * System must NOT silently create inventory.
     * 
     * <p>Requires reconciliation via:
     * <ul>
