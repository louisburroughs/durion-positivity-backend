 ...
 * 
 * <p>These event types are used to compute On-Hand and Available-to-Promise (ATP) quantities
 * as defined in ADR-0001 (Inventory Ledger ATP Computation).
 * 
 * <p><strong>On-Hand Calculation:</strong> Net sum of physical stock movement events.
 * On-Hand events include: INBOUND (positive) and OUTBOUND (negative) event types.
 * 
 * <p><strong>ATP Calculation:</strong> ATP = On-Hand - Allocations.
 * Reservation and allocation events affect availability but NOT physical on-hand.
 * 
 * @see <a href="/docs/adr/0001-inventory-ledger-atp-computation.md">ADR-0001</a>
 */
public enum InventoryLedgerEventType {
    ...
    /**
     * Inventory issued or consumed to work order, production, or job.
     * Direction: OUTBOUND (-)
     * Affects On-Hand: YES
     */
