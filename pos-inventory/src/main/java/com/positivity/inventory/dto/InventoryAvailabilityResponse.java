 ...
 * 
 * <p>Represents the current inventory availability for a product at a specific location,
 * including on-hand quantity, allocations, and available-to-promise (ATP).
 * 
 * <p>ATP is calculated as: ATP = On-Hand - Allocations
 * (Expected Receipts are not included in v1 - see ADR-0001)
 * 
 * <p>All quantities are in the product's base unit of measure.
 * 
