...
public class CycleCountAdjustmentController {
     ...
     * 
     * <p>The adjustment will be evaluated against approval thresholds:
     * <ul>
     ...
     * 
     * <p>Requires the user to have INVENTORY_ADJUSTMENT_APPROVE permission.
    ...
    public ResponseEntity<AdjustmentResponse> approveAdjustment(
            @Parameter(description = "Adjustment ID", required = true)
    ...
    public ResponseEntity<List<AdjustmentResponse>> listAdjustments(
            @Parameter(description = "Filter by adjustment status")
