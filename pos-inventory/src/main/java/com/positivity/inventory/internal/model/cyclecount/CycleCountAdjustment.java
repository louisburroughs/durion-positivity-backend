 ...
 * 
 * <p>Tracks the complete lifecycle from proposal through approval/rejection to posting.
...
public class CycleCountAdjustment {
    ...
    /**
     * Reason code for the adjustment (e.g., 'CYCLE_COUNT_SHRINK', 'CYCLE_COUNT_OVERAGE').
     */
    @Column(nullable = false)
    private String reasonCode;
    
    /**
     * The variance quantity to be applied. Can be positive (overage) or negative (shrinkage).
     */
    @Column(nullable = false)
