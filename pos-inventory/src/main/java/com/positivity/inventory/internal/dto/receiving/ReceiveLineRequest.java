...
public class ReceiveLineRequest {
    ...
    /**
     * Convenience constructor for the pre-E3 field set (no expiration date, no serials);
     * expirationDate and serialNumbers default to null. The full-field constructor is generated by
    ...
    public ReceiveLineRequest(
        ...
        this(lineId, receivedQuantity, lotNumber, documentUom, documentQuantity, null, null);
    }

    /**
     * Convenience constructor for the pre-E4 field set (no serials); serialNumbers defaults to null.
     */
    public ReceiveLineRequest(
            UUID lineId,
            BigDecimal receivedQuantity,
        ...
        this(lineId, receivedQuantity, lotNumber, documentUom, documentQuantity, expirationDate, null);
    }
