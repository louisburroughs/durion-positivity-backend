...
public class ReservationController {
        ...
        public ResponseEntity<ReservationResponse> createOrUpdateReservation(
                        @io.swagger.v3.oas.annotations.parameters.RequestBody(required = true, description = "Reservation create/update payload", content = @Content(schema = @Schema(implementation = CreateReservationRequest.class))) @Valid @RequestBody CreateReservationRequest request) {
        ...
        public ResponseEntity<ReservationResponse> promoteToHard(
                        @Parameter(description = "Allocation identifier to promote", required = true) @PathVariable UUID allocationId,
                        @io.swagger.v3.oas.annotations.parameters.RequestBody(required = true, description = "Promotion request details", content = @Content(schema = @Schema(implementation = PromoteAllocationRequest.class))) @Valid @RequestBody PromoteAllocationRequest request) {
