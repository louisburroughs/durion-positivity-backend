 ...
 * contributor in {@code /actuator/health} plus the {@code inventory.outbox.pending} and
 * {@code inventory.outbox.oldest.age.seconds} gauges that the domain-events Grafana alerts fire on.
 *
