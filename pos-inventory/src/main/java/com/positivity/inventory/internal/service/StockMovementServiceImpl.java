...
public class StockMovementServiceImpl implements StockMovementService {
    ...
    public @NonNull InventoryLedgerEntry recordMovement(@NonNull RecordMovementRequest request,
        ...
        InventoryLedgerEntry entry = InventoryLedgerEntry.builder()
                ...
                .fromLocationId(movementType == MovementType.TRANSFER ? request.getLocationId() : null)
                .toLocationId(movementType == MovementType.TRANSFER ? request.getToLocationId() : null)
                .eventType(eventType)
