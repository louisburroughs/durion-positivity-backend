 ...
 * of canonical UUID strings (ADR-0061 §2, #1878). Used for the materialised location-scope
 * ancestor sets on {@link LocationRefEntity}.
 *
 ...
 *
 * <p>Per-module copy of the pos-people converter: replicas never import another module's
 * internals (ADR-0026).
 */
@Converter
