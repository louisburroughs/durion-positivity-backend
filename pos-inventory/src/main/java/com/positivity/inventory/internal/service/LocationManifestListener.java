...
/**
 * Consumer-side reconciliation for the inventory location replicas (ADR-0044 §4, issue #892).
 *
...
public class LocationManifestListener {
    ...
    @KafkaListener(
            topics = "${pos.inventory.kafka.location-manifest-topic:location.manifest.v1}",
            groupId = "${pos.inventory.kafka.location-manifest-consumer-group:pos-inventory-location-manifests}")
