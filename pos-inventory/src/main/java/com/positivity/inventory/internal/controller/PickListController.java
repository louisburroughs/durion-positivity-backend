...
public class PickListController {
    ...
    @ApiResponse(responseCode = "403", description = "User lacks required pick list authority", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InventoryErrorResponse.class)))
    ...
    @ApiResponse(responseCode = "403", description = "User lacks required pick list authority", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InventoryErrorResponse.class)))
    @ApiResponse(responseCode = "404", description = "Pick list not found", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InventoryErrorResponse.class)))
    ...
    @ApiResponse(responseCode = "400", description = "Invalid workorder identifier", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InventoryErrorResponse.class)))
    @ApiResponse(responseCode = "403", description = "User lacks required pick list authority", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InventoryErrorResponse.class)))
    ...
    @ApiResponse(responseCode = "400", description = "Validation failure", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InventoryErrorResponse.class)))
    @ApiResponse(responseCode = "403", description = "User lacks required pick task authority", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InventoryErrorResponse.class)))
    @ApiResponse(responseCode = "404", description = "Pick list or pick task not found", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InventoryErrorResponse.class)))
    @ApiResponse(responseCode = "422", description = "Pick confirmation failed business validation", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InventoryErrorResponse.class)))
