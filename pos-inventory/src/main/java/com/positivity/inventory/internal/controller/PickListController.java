...
public class PickListController {
        ...
        public ResponseEntity<PickTaskResponse> confirmPickTask(
                        ...
                        @io.swagger.v3.oas.annotations.parameters.RequestBody(required = true, description = "Pick task confirmation payload", content = @Content(schema = @Schema(implementation = ConfirmPickTaskRequest.class))) @Valid @RequestBody ConfirmPickTaskRequest request) {
        ...
        public ResponseEntity<PickListResponse> updatePickListStatus(
                        @Parameter(description = "Pick list identifier", required = true) @PathVariable UUID pickListId,
                        @io.swagger.v3.oas.annotations.parameters.RequestBody(required = true, description = "Pick list status update payload", content = @Content(schema = @Schema(implementation = UpdatePickListStatusRequest.class))) @Valid @RequestBody UpdatePickListStatusRequest request) {
