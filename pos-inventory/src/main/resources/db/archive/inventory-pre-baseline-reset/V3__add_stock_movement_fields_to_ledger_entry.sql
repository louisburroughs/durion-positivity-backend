...
ALTER TABLE IF EXISTS inventory_ledger_entry ADD COLUMN IF NOT EXISTS from_location_id UUID;
ALTER TABLE IF EXISTS inventory_ledger_entry ADD COLUMN IF NOT EXISTS to_location_id UUID;
