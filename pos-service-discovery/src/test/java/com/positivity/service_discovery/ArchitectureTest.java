package com.positivity.service_discovery;
...
/**
 * ArchUnit tests enforcing architecture rules for pos-service-discovery module.
 * 
 * Enforces:
 ...
 */
@AnalyzeClasses(packages = "com.positivity.service_discovery", importOptions = ImportOption.DoNotIncludeTests.class)
public class ArchitectureTest {
    ...
    private static final DescribedPredicate<JavaCall<?>> UUID_RANDOM_UUID_CALL = new DescribedPredicate<>(
        ...
        static final ArchRule spring_boot_application_should_be_in_root_package = classes()
                        ...
                        .should().resideInAPackage("com.positivity.service_discovery")
        ...
        static final ArchRule only_service_layer_should_be_public_api = classes()
                        .that().resideInAPackage("com.positivity.service_discovery.service..")
                        .should().bePublic()
                        .allowEmptyShould(true)
        ...
        static final ArchRule packages_should_be_free_of_cycles = slices()
                        .matching("com.positivity.service_discovery.internal.(*)..")
