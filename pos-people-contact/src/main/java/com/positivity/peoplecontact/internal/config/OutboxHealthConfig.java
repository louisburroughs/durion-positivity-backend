 ...
 * contributor in {@code /actuator/health} plus the {@code people_contact.outbox.pending} and
 * {@code people_contact.outbox.oldest.age.seconds} gauges that the domain-events Grafana alerts fire on.
 *
