...
public interface OutboxEventRepository extends JpaRepository<OutboxEvent, UUID> {
    ...
    /** Unpublished backlog depth — drives the {@code people_contact.outbox.pending} gauge (#1458). */
    long countByPublishedAtIsNull();

    /**
     * Oldest unpublished row (drain head) — drives the {@code people_contact.outbox.oldest.age.seconds} gauge
