...
/**
 * ArchUnit tests enforcing architecture rules for pos-events module.
 *
 * Enforces:
...
public class ArchitectureTest {
    ...
    static final ArchRule spring_boot_application_should_be_in_root_package = classes()
            ...
            .should()
            .resideInAPackage("com.positivity.events")
            .andShould()
    ...
    static final ArchRule only_service_layer_should_be_public_api = classes()
            .that()
            .resideInAPackage("com.positivity.events.service..")
            .should()
            .bePublic()
            .allowEmptyShould(true)
    ...
    // depend on this module's internal implementation. pos-events holds no grant, so this package
    // is empty; the rule (with allowEmptyShould) keeps it honest if a grant is ever added.
    // Package patterns are exact-anchored on purpose: "com.positivity.events.service.." must NOT
    // match "com.positivity.events.internal.service".
    @ArchTest
    static final ArchRule public_service_surface_should_not_depend_on_internal = noClasses()
            ...
            .should()
            .dependOnClassesThat()
            .resideInAPackage("com.positivity.events.internal..")
            .allowEmptyShould(true)
    ...
    // Issue CAP-169: Allow empty cycle checks because this module may not define
    // sub-slices under com.positivity.events.
    @ArchTest
    static final ArchRule packages_should_be_free_of_cycles = slices().matching("com.positivity.events.internal.(*)..")
            .should()
            .beFreeOfCycles()
            .allowEmptyShould(true)
