 ...
 */
public record EventEmitted(String eventId, String apiVersion, long timestamp, long elapsedMs, Instant publishedAt) {
    ...
    public static EventEmitted from(
            String eventId, String apiVersion, long timestamp, long elapsedMs, Instant publishedAt) {
