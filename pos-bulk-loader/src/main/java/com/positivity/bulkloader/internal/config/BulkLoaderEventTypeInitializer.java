...
@Component
public class BulkLoaderEventTypeInitializer implements ApplicationRunner {

    private static final Logger log = LoggerFactory.getLogger(BulkLoaderEventTypeInitializer.class);

    private final RestClient restClient;
    private final EventTypeInitializerSupport initializerSupport;
    private final String apiSecret;

    public BulkLoaderEventTypeInitializer(
        ...
        this.restClient = restClientBuilder
                ...
                .build();
        this.initializerSupport = new EventTypeInitializerSupport("pos-bulk-loader");
    ...
    public void run(ApplicationArguments args) {
        log.info(
                "Registering {} bulk loader event types",
                BulkLoaderEventTypes.all().size());
        initializerSupport.registerEventTypes(BulkLoaderEventTypes.all(), this::registerEventType);
        log.info("Bulk loader event type registration complete");
    }
