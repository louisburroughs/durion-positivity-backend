...
/**
 * ArchUnit tests enforcing architecture rules for pos-vehicle-reference-carapi module.
 * 
 * Enforces:
...
public class ArchitectureTest {
    ...
    static final ArchRule spring_boot_application_should_be_in_root_package = classes()
            ...
            .should().resideInAPackage("com.positivity.vehicle_reference_carapi")
    ...
    static final ArchRule only_service_layer_should_be_public_api = classes()
            .that().resideInAPackage("com.positivity.vehicle_reference_carapi.service..")
            .should().bePublic()
            .allowEmptyShould(true)
    ...
    static final ArchRule packages_should_be_free_of_cycles = slices()
            .matching("com.positivity.vehicle_reference_carapi.internal.(*)..")
