...
class StorageLocationServiceTest {
        ...
        void listStorageLocations_filterByType_returnsFiltered() {
                ...
                when(storageLocationRepository.findBySiteIdAndType(siteId, StorageLocationType.BIN,
                                PageRequest.of(0, 20)))
                                .thenReturn(page);
        ...
        void deactivateStorageLocation_withInventoryAndDestination_transfersInventory() {
                ...
                when(storageLocationRepository.findByIdAndSiteId(destinationId, siteId))
        ...
        void patchStorageLocation_validPatch_updatesFields() {
                ...
                when(storageLocationRepository.existsByNameIgnoreCaseAndSiteIdAndIdNot("Bin-New", siteId,
                                storageLocationId))
                                .thenReturn(false);
                ...
                StorageLocationResponse response = storageLocationService.patchStorageLocation(siteId,
                                storageLocationId,
                                patch);
        ...
        void patchStorageLocation_duplicateName_throwsConflict() {
                ...
                when(storageLocationRepository.findByIdAndSiteId(storageLocationId, siteId))
                                .thenReturn(Optional.of(existing));
                when(storageLocationRepository.existsByNameIgnoreCaseAndSiteIdAndIdNot("Bin-Dup", siteId,
                                storageLocationId))
                                .thenReturn(true);
