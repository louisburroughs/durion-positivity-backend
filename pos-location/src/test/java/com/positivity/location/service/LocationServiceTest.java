...
class LocationServiceTest {
        ...
        void createLocation_validPayload_returnsLocationResponse() {
                ...
                LocationType locationType = LocationType.builder()
                                .id(UUID.fromString("00000000-0000-0000-0000-000000000001")).name("Shop")
        ...
        void createLocation_duplicateName_throwsConflict() {
                ...
                LocationType locationType = LocationType.builder()
                                .id(UUID.fromString("00000000-0000-0000-0000-000000000001")).name("Shop").build();

                when(locationTypeRepository.findByNameIgnoreCase("Shop")).thenReturn(Optional.of(locationType));
                when(locationRepository.saveAndFlush(any(Location.class)))
                                .thenReturn(savedLocation(UUID.fromString("00000000-0000-0000-0000-000000000001"),
                                                first, locationType))
                                .thenReturn(savedLocation(UUID.fromString("00000000-0000-0000-0000-000000000001"),
                                                duplicateNameDifferentCase, locationType));
        ...
        void createLocation_serializesScheduleFieldsAsCanonicalJson() {
                ...
                request.setHolidayClosures(List.of(
                                HolidayClosureRequest.builder().date(LocalDate.of(2026, 12, 25)).reason("Christmas")
                                                .build(),
                                HolidayClosureRequest.builder().date(LocalDate.of(2026, 1, 1)).reason("New Year")
                                                .build()));
                LocationType locationType = LocationType.builder()
                                .id(UUID.fromString("00000000-0000-0000-0000-000000000001")).name("Shop").build();
        ...
        void createLocation_codeUniqueConstraintViolation_mapsToLocationCodeTaken() {
                ...
                when(locationRepository.saveAndFlush(any(Location.class)))
                                .thenThrow(new DataIntegrityViolationException(
                                                "duplicate key value violates location_code_key"));
        ...
        void updateLocation_validPayload_returnsResponse() {
                ...
                Location existing = savedLocation(id, validRequest("Legacy Name", "UPD-001"),
                                LocationType.builder().id(UUID.fromString("00000000-0000-0000-0000-000000000001"))
                                                .name("Shop").build());
        ...
        void patchLocation_duplicateName_throwsConflict() {
                ...
                when(locationRepository.findByNormalizedNameAndIdNot("duplicate name", id))
                                .thenReturn(Optional.of(
                                                savedLocation(UUID.fromString("00000000-0000-0000-0000-000000000001"),
                                                                validRequest("Duplicate Name", "DUP-001"),
                                                                LocationType.builder().id(UUID.fromString(
        ...
        void patchLocation_serializesScheduleFieldsAsCanonicalJson() {
                ...
                LocationPatchRequest patch = LocationPatchRequest.builder()
                                .operatingHours(List.of(
                                                OperatingHoursRequest.builder().dayOfWeek("WEDNESDAY")
                                                                .openTime(LocalTime.of(10, 0))
                                                                .closeTime(LocalTime.of(19, 0)).build(),
                                                OperatingHoursRequest.builder().dayOfWeek("MONDAY")
                                                                .openTime(LocalTime.of(8, 0))
                                                                .closeTime(LocalTime.of(17, 0)).build()))
                                .holidayClosures(List.of(
                                                HolidayClosureRequest.builder().date(LocalDate.of(2026, 11, 26))
                                                                .reason("Thanksgiving")
                                                                .build(),
                                                HolidayClosureRequest.builder().date(LocalDate.of(2026, 1, 1))
                                                                .reason("New Year").build()))
                                .build();
        ...
        void getAllLocationsDto_mapsRepositoryEntitiesToDtos() {
                LocationType locationType = LocationType.builder()
                                .id(UUID.fromString("00000000-0000-0000-0000-000000000001")).name("Shop").build();
                Location location = savedLocation(UUID.fromString("00000000-0000-0000-0000-000000000001"),
                                validRequest("List Shop", "LST-001"), locationType);
        ...
        void getAllChildrenDto_withParentType_filtersByType() {
                ...
                Location child = Location.builder().id(UUID.fromString("00000000-0000-0000-0000-000000000001"))
                                .name("Typed Child").active(true).build();
