 ...
 * - ParentType supports ADR-0016 values: PHYSICAL, ORGANIZATIONAL, FINANCIAL,
 * SHIPPING
 * - Legacy parent types may remain supported during migration
 * - Location response includes {@code geographicalLocationId} field
 * - Endpoints are served at /v1/locations (not /v1/locations)
...
class LocationADR0016ContractBehaviorIT extends BaseContractIntegrationTest {
    ...
    @Test
    @DisplayName("CP-119-001: POST /v1/locations (not /v1/locations) returns 201")
