...
class LocationOpenApiContractTest extends BaseContractIntegrationTest {
    ...
    void openApiSpec_locationEndpoints_haveRequiredSummaryAndDescription() throws Exception {
        ...
        assertOperationSummaryAndDescription(paths, "/v1/locations/{siteId}/storage-locations/{storageLocationId}", "get");
        assertOperationSummaryAndDescription(paths, "/v1/locations/{siteId}/storage-locations/{storageLocationId}", "patch");
    }
