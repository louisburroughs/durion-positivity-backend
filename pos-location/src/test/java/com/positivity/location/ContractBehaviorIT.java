...
class ContractBehaviorIT {
    ...
    void testGetLocation_HappyPath() throws Exception {
        ...
        String locationId = objectMapper.readTree(responseBody).get("id").asText();
    ...
    void testUpdateLocation_InvalidStateTransition() throws Exception {
        ...
        String locationId = objectMapper.readTree(createResult.getResponse().getContentAsString()).get("id").asText();
