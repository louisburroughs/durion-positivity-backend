...
public final class LocationEventTypes {
        ...
        public static final EventTypeRegistration LOCATION_BAY_UPDATE = EventTypeRegistration
                        .write("LOCATION_BAY_UPDATE", "Update a bay").build();
        ...
        public static final EventTypeRegistration LOCATION_MOBILE_UNIT_UPDATE = EventTypeRegistration
                        .write("LOCATION_MOBILE_UNIT_UPDATE", "Update an existing mobile unit").build();
