 ...
 * contributor in {@code /actuator/health} plus the {@code location.outbox.pending} and
 * {@code location.outbox.oldest.age.seconds} gauges that the domain-events Grafana alerts fire on.
 *
