...
public class ManifestPublisher {
    ...
    @PlatformScoped(
            reason =
                    "summarises event_outbox, a global table, per window across every tenant; consumers compare against"
                            + " their global processed-events ledger (per-tenant manifests are plan WS4-3)")
