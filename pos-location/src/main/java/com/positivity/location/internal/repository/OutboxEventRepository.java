...
public interface OutboxEventRepository extends JpaRepository<OutboxEvent, UUID> {
    ...
    /** Unpublished backlog depth — drives the {@code location.outbox.pending} gauge (#1458). */
    long countByPublishedAtIsNull();

    /**
     * Oldest unpublished row (drain head) — drives the {@code location.outbox.oldest.age.seconds} gauge
