...
import com.positivity.accounting.audit.entity.*;
import com.positivity.accounting.audit.event.*;
import com.positivity.accounting.audit.repository.AuditTrailEntryRepository;
...
public class AuditTrailService {
    ...
    public AuditTrailResponse recordPriceOverride(PriceOverrideRequest request) {
        ...
        PriceOverrideAuthorizationService.AuthorizationResult authResult = 
            overrideAuthService.validate(
    ...
    public AuditTrailResponse recordRefund(RefundRequest request) {
        ...
        // Validate authorization
        RefundAuthorizationService.RefundAuthorizationResult authResult = 
            refundAuthService.validate(
                request.getActorRole(),
