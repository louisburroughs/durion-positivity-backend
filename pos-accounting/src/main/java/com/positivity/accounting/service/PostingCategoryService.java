...
public interface PostingCategoryService {
     ...
     */
    PostingCategoryResponse updatePostingCategory(UUID postingCategoryId, PostingCategoryUpdateRequest request);
     ...
     */
    PostingCategoryListResponse listPostingCategories(int page, int size, String sort, Boolean isActive);
