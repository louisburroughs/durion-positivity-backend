...
public class GLMappingServiceImpl implements GLMappingService {
    ...
    public @NonNull GLMappingCreateResponse createMapping(@NonNull GLMappingCreateRequest request) {
        ...
        // Set dummy values for required fields (postingCategoryId and mappingKeyId)
        // These are not used for source/external code resolution but required by schema
        mapping.setPostingCategoryId(UUID.fromString("00000000-0000-0000-0000-000000000000"));
        mapping.setMappingKeyId(UUID.fromString("00000000-0000-0000-0000-000000000000"));
