...
public interface MappingKeyService {
     ...
     */
    MappingKeyResponse updateMappingKey(UUID mappingKeyId, MappingKeyUpdateRequest request);
    ...
    MappingKeyListResponse listMappingKeysByCategory(
            UUID postingCategoryId, int page, int size, String sort, Boolean isActive);
