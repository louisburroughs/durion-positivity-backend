...
/**
 * REST API for the period-close-aligned Sales-Tax Liability freeze (issue #998, Phase-2 scope
 * item 2).
 *
 * <p>Freezing captures the T8 report (issue #966) for a CLOSED accounting period as an immutable,
 * re-derivable snapshot with a canonical SHA-256 content hash; verify re-derives the report from
 * live data and compares. Provider-neutral per the #998 decision record — snapshots carry no
