...
public class ReportExportResponse {
   ...
   */
  @Schema(description = "ISO-8601 timestamp when export completed (null if not finished)", example = "2026-04-25T10:00:05Z")
   ...
   */
  @Schema(description = "Download URL (only present when status is COMPLETED)", example = "https://storage.example.com/exports/export-abc.csv")
