...
public class CreditMemoController {
        ...
        public ResponseEntity<CreditMemoResponse> createCreditMemo(
                ...
                log.info("Creating Credit Memo for invoice {} requested by user {}",
                                request.getOriginalInvoiceId(), currentUser);
        ...
        public ResponseEntity<Page<CreditMemoResponse>> listCreditMemos(
                ...
                log.debug("Listing Credit Memos: customerId={}, invoiceId={}, status={}, page={}",
