...
public class EventIngestionController {
    ...
    public ResponseEntity<PagedResponse<AccountingEventResponse>> listEvents(
        ...
        Page<AccountingEventResponse> eventPage = eventIngestionService.listEvents(organizationId, status, pageable);

        PagedResponse<AccountingEventResponse> response = new PagedResponse<>(
                eventPage.getContent(), eventPage.getNumber(), eventPage.getSize(), eventPage.getTotalElements());
