 ...
 * sets ADR-0061 §2 evaluates in-process, so that {@link com.positivity.accounting.internal.controller.LaborOverheadReportController#generateLaborOverheadReport} can be enforced without a
