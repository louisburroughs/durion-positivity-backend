...
/**
 * Enables Kafka listener infrastructure for pos-accounting when Kafka integration
 * is enabled.
 *
 * <p>Activation is controlled by {@code pos.accounting.kafka.enabled=true} in
...
public class AccountingKafkaConfig {
}
