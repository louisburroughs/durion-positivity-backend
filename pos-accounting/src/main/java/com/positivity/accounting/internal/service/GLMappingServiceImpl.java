...
public class GLMappingServiceImpl implements GLMappingService {
    ...
    public @NonNull GLMappingCreateResponse createMapping(@NonNull GLMappingCreateRequest request) {
        log.info(
                "Creating GL mapping: sourceSystem={}, externalCode={}, glAccountId={}",
        ...
        log.info(
                "Created GL mapping: id={}, sourceSystem={}, externalCode={}",
                saved.getGlMappingId(),
        ...
        return GLMappingCreateResponse.builder().mapping(mappingResponse).build();
    }

    @Override
    public @NonNull GLMappingResolveResponse resolveMapping(@NonNull GLMappingResolveRequest request) {
        log.info(
                "Resolving GL mapping: sourceSystem={}, externalCode={}, transactionDate={}",
                request.getSourceSystem(),
                request.getExternalCode(),
        ...
        return GLMappingResolveResponse.builder().glAccountId(glAccountId).build();
    }
