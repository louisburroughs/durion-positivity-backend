 ...
 * CRUD
 *
 * This test suite validates the behavioral contracts for CAP:050 - Posting
 * Categories and Mapping Keys.
 *
 * Scope: Happy path, validation errors, uniqueness constraints, and
 * deactivation rules
 *
...
public class PostingCategoryMappingKeyContractBehaviorIT extends BaseIntegrationTest {
        ...
        private UUID createMappingKey(UUID categoryId, String keyName, String description, String createdBy)
                        throws Exception {
                MappingKeyCreateRequest request = new MappingKeyCreateRequest();
                request.setPostingCategoryId(categoryId);
