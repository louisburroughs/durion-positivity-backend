...
class ContractBehaviorIT extends BaseContractIntegrationTest {
    ...
    void testCreateJournalEntryHappyPath() throws Exception {
        ...
        JournalEntryCreateRequest request =
                createBalancedJournalEntryRequest(debitAccountId, creditAccountId, "Daily sales deposit", "SALE");
    ...
    void testJournalEntryAuditFieldsPopulated() throws Exception {
        ...
        // Prepare journal entry request
        JournalEntryCreateRequest request =
                createBalancedJournalEntryRequest(debitAccountId, creditAccountId, "Audit field test entry", "TEST");
    ...
    void testJournalEntryIdempotency() throws Exception {
        ...
        JournalEntryCreateRequest request =
                createBalancedJournalEntryRequest(debitAccountId, creditAccountId, "Test entry", "SALE");
        ...
        UUID firstEntryId = UUID.fromString(objectMapper
    ...
    void testOptimisticLockingPreventsConflict() throws Exception {
        ...
        MvcResult createResult = mockMvc.perform(withAuth(post(API_V1 + "/gl-accounts"))
                        ...
                        .content(objectMapper.writeValueAsString(
                                createGLAccountRequest("1000-000", "Cash", AccountType.ASSET))))
                .andExpect(status().isCreated())
                .andReturn();

        UUID accountId = UUID.fromString(objectMapper
                .readTree(createResult.getResponse().getContentAsString())
                .get("glAccountId")
                .asString());

        // Act: Attempt update - test endpoint behavior
        GLAccountCreateRequest updateRequest =
                createGLAccountRequest("1000-000", "Updated Cash Account", AccountType.ASSET);
    ...
    void testJournalEntryBalanceInvariant() throws Exception {
        ...
        JournalEntryCreateRequest request =
                createBalancedJournalEntryRequest(debitAccountId, creditAccountId, "Entry to verify creation", "SALE");
    ...
    private JournalEntryCreateRequest createBalancedJournalEntryRequest(
            UUID debitAccountId, UUID creditAccountId, String description, String sourceEventType) {
