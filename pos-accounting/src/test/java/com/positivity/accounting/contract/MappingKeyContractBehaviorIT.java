...
public class MappingKeyContractBehaviorIT extends BaseContractIntegrationTest {
    ...
    void testUpdateMappingKey_Success() {
        ...
        MappingKeyUpdateRequest updateRequest = MappingKeyUpdateRequest.builder()
                ...
                .build();
        MappingKeyResponse updated = mappingKeyService.updateMappingKey(created.getMappingKeyId(), updateRequest);
    ...
    void testListMappingKeysByCategory_Success() {
        ...
        MappingKeyListResponse response =
                mappingKeyService.listMappingKeysByCategory(category.getPostingCategoryId(), 0, 10, "keyName", null);
