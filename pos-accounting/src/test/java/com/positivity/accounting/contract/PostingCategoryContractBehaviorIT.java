...
public class PostingCategoryContractBehaviorIT extends BaseContractIntegrationTest {
    ...
    void testUpdatePostingCategory_Success() {
        ...
        PostingCategoryUpdateRequest updateRequest = PostingCategoryUpdateRequest.builder()
                ...
                .build();
        PostingCategoryResponse updated =
                postingCategoryService.updatePostingCategory(created.getPostingCategoryId(), updateRequest);
    ...
    void testDeactivatePostingCategory_Success() {
        ...
        // When
        PostingCategoryResponse deactivated =
                postingCategoryService.deactivatePostingCategory(created.getPostingCategoryId());
    ...
    void testListPostingCategories_FilterByActive() {
        ...
        PostingCategoryListResponse response =
                postingCategoryService.listPostingCategories(0, 10, "categoryName", true);

        // Then
        assertThat(response.getResults()).isNotEmpty();
        assertThat(response.getResults()).allMatch(category -> category.getIsActive());
    }
