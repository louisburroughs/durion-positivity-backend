...
class ReportExportControllerTest extends BaseIntegrationTest {
    ...
    class RequestExport {
        ...
        void requestExport_whenValid_returns201() throws Exception {
            when(reportExportService.requestExport(any(ReportExportRequest.class), any(String.class)))
    ...
    class GetExportStatus {
        ...
        void getExportStatus_whenFound_returns200() throws Exception {
            when(reportExportService.getExportStatus(EXPORT_ID)).thenReturn(exportResponse);
    ...
    class GetExportHistory {
        ...
        void getExportHistory_returns200() throws Exception {
            ...
            when(reportExportService.getExportHistory(any(Pageable.class))).thenReturn(page);
