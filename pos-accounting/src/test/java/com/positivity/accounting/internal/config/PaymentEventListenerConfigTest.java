...
class PaymentEventListenerConfigTest {
        ...
        private final PaymentApplicationService paymentApplicationService = Mockito
        ...
        class OnPaymentCleared {
                ...
                void processesValidPaymentClearedMessage() throws Exception {
                        ...
                        when(paymentApplicationService.handlePaymentCleared(
                ...
                void rethrowsServiceExceptions() throws Exception {
                        ...
                        verify(paymentApplicationService).handlePaymentCleared(
                                        eq(paymentId), eq(customerId), any(), any(), any(), eq(eventId));
                }
        }
}
