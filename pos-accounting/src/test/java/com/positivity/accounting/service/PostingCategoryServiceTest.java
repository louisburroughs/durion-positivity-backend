...
class PostingCategoryServiceTest {
    ...
    class ListPostingCategories {
        ...
        void allCategories() {
            Page<PostingCategory> page = new PageImpl<>(List.of(testCategory), PageRequest.of(0, 10), 1);
        ...
        void withIsActiveFilter() {
            ...
            when(postingCategoryRepository.findAll(
                            org.mockito.ArgumentMatchers
                                    .<org.springframework.data.jpa.domain.Specification<PostingCategory>>any(),
                            any(Pageable.class)))
                    .thenReturn(page);
