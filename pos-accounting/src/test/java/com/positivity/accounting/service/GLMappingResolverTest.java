...
class GLMappingResolverTest {
    ...
    class ExactDimensionalMatching {
        ...
        void shouldResolveExactDimensionalMatch() {
            ...
            // Act
            UUID result = resolver.resolveGLAccount(postingCategoryId, mappingKeyId, transactionDate, dimensions);
        ...
        void shouldNotMatchWhenDimensionsDiffer() {
            ...
            when(mappingRepository.findEffectiveMapping(eq(postingCategoryId), eq(mappingKeyId), eq(transactionDate)))
                    .thenReturn(Optional.of(defaultMapping));

            // Act
            UUID result =
                    resolver.resolveGLAccount(postingCategoryId, mappingKeyId, transactionDate, requestDimensions);
        ...
        void shouldSkipNullDimensionContext() {
            ...
            // Act
            UUID result = resolver.resolveGLAccount(postingCategoryId, mappingKeyId, transactionDate, null);
        ...
        void shouldSkipEmptyDimensionContext() {
            ...
            // Act
            UUID result =
                    resolver.resolveGLAccount(postingCategoryId, mappingKeyId, transactionDate, Collections.emptyMap());
    ...
    class DimensionalFallback {
        ...
        void shouldFallBackToBusinessUnitOnly() {
            ...
            Map<String, String> mappingDimensions = Map.of("businessUnitId", "BU-001");
        ...
        void shouldPreferMoreSpecificFallback() {
            ...
            Map<String, String> broadDimensions = Map.of("businessUnitId", "BU-001"); // 1 dimension
    ...
    class ResolutionPriority {
        ...
        void shouldPreferExactOverFallbackAndDefault() {
            ...
            GLMapping exactMapping =
                    createMapping(exactAccountId, Map.of("businessUnitId", "BU-001", "locationId", "LOC-100"));
            GLMapping fallbackMapping = createMapping(fallbackAccountId, Map.of("businessUnitId", "BU-001"));
            GLMapping defaultMapping = createMapping(defaultAccountId, null);
