...
class APPaymentServiceTest {
        ...
        void executePayment_Success_GatewaySucceeded() {
                ExecuteAPPaymentRequest request = buildRequest(testPaymentRef, testVendorId, new BigDecimal("1500.00"),
                                PaymentMethod.ACH);
        ...
        void executePayment_WithExplicitPaymentSource() {
                ExecuteAPPaymentRequest request = buildRequest(testPaymentRef, testVendorId, new BigDecimal("1000.00"),
                                PaymentMethod.WIRE);
        ...
        void executePayment_Idempotent_ReturnExisting() {
                ...
                APPayment existingPayment = buildExistingPayment(
                                TEST_PAYMENT_ID, testPaymentRef, testVendorId, new BigDecimal("1500.00"),
                                PaymentMethod.ACH);
        ...
        private APPayment buildExistingPayment(
                        UUID paymentId, String paymentRef, UUID vendorId, BigDecimal grossAmount,
                        PaymentMethod method) {
