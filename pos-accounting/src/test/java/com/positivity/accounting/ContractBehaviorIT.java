...
public class ContractBehaviorIT {
    ...
    private String apiV1 = "/rest/api/v1";
    ...
    public void testCreateGLAccountHappyPath() throws Exception {
        ...
        MvcResult result = mockMvc.perform(post(apiV1 + "/accounting/gl-accounts")
    ...
    public void testCreateJournalEntryHappyPath() throws Exception {
        ...
        mockMvc.perform(post(apiV1 + "/accounting/journal-entries")
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(request)))
                .andDo(print())
                .andExpect(status().isCreated())
    ...
    public void testCreateGLAccountInvalidCodeFormat() throws Exception {
        ...
        mockMvc.perform(post(apiV1 + "/accounting/gl-accounts")
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(request)))
                .andDo(print())
    ...
    public void testJournalEntryIdempotency() throws Exception {
        ...
        // Act: First request
        MvcResult firstResult = mockMvc.perform(post(apiV1 + "/accounting/journal-entries")
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(request)))
                .andExpect(status().isCreated())
                .andReturn();
    ...
    public void testOptimisticLockingPreventsConflict() throws Exception {
        ...
        MvcResult createResult = mockMvc.perform(post(apiV1 + "/accounting/gl-accounts")
                .contentType(MediaType.APPLICATION_JSON)
                .content(
                        objectMapper.writeValueAsString(createGLAccountRequest("1000-000", "Cash", AccountType.ASSET))))
                .andExpect(status().isCreated())
                .andReturn();
        ...
        mockMvc.perform(put(apiV1 + "/accounting/gl-accounts/" + accountId)
                .contentType(MediaType.APPLICATION_JSON)
    ...
    public void testJournalEntryBalanceInvariant() throws Exception {
        ...
        // Act: Create entry
        MvcResult result = mockMvc.perform(post(apiV1 + "/accounting/journal-entries")
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(request)))
                .andExpect(status().isCreated())
                .andReturn();
