...
public final class CatalogEventTypes {
        ...
        public static List<EventTypeRegistration> all() {
                return List.of(
                                ...
                                EventTypeRegistration.write("CATALOG_ITEM_DELETE",
                                                "Delete an existing catalog item").build(),
                                ...
                                EventTypeRegistration.write("CATALOG_CATALOG_DELETE",
                                                "Delete an existing catalog").build(),
