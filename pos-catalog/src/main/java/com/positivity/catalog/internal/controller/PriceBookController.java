...
public class PriceBookController {
    ...
    @Operation(summary = "Get price book")
    ...
    @Operation(summary = "Update price book")
    ...
    @Operation(summary = "Create price book rule")
    ...
    @Operation(summary = "Update price book rule")
    ...
    @Operation(summary = "Deactivate price book rule")
    ...
    @Operation(summary = "List price book rules")
    ...
    @Operation(summary = "Resolve effective product price")
