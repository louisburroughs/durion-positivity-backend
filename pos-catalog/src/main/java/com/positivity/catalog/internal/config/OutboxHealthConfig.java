 ...
 * contributor in {@code /actuator/health} plus the {@code catalog.outbox.pending} and
 * {@code catalog.outbox.oldest.age.seconds} gauges that the domain-events Grafana alerts fire on.
 *
