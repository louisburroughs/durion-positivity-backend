...
public interface LocationPriceOverrideService {
    ...
    LocationPriceOverrideResponseDto upsertLocationGuardrailPolicy(GuardrailPolicyUpsertRequestDto request);
    ...
    LocationPriceOverrideResponseDto approveOverride(UUID overrideId, LocationPriceOverrideDecisionRequestDto request);

    LocationPriceOverrideResponseDto rejectOverride(UUID overrideId, LocationPriceOverrideDecisionRequestDto request);
}
