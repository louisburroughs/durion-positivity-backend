 ...
 * {@link com.positivity.catalog.tenancy.PostgresTenancyTestBase} and the {@code @DataJpaTest}
 * {@link PostgresSliceTestBase} — and the repository already pays for one copy of this bootstrap
 * too many.
 *
 * <p>Requires Docker.
 */
public final class CatalogPostgresContainer {
    ...
    private CatalogPostgresContainer() {}
