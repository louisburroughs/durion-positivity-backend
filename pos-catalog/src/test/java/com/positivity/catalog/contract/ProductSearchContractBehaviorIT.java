 ...
 * free-text query, brand, category, and SKU filters. Tests are intentionally
 * RED because {@code ProductSearchServiceImpl} currently returns an empty
 * scaffold result for all queries.
 *
 * <p>
