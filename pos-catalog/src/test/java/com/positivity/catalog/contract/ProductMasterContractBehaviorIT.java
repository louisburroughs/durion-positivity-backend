...
class ProductMasterContractBehaviorIT extends BaseContractIntegrationTest {
        ...
        void createProduct_returnsCreated() throws Exception {
                mockMvc.perform(withAuth(post("/v1/products")
                                ...
                                .content(objectMapper
                                                .writeValueAsString(validCreatePayload("SKU-165-001", "MPN-165-001")))))
        ...
        void duplicateSku_returnsConflict() throws Exception {
                mockMvc.perform(withAuth(post("/v1/products")
                                .contentType(MediaType.APPLICATION_JSON)
                                .content(objectMapper
                                                .writeValueAsString(validCreatePayload("SKU-165-DUP", "MPN-165-A")))))
                                .andExpect(status().isCreated());

                mockMvc.perform(withAuth(post("/v1/products")
                                .contentType(MediaType.APPLICATION_JSON)
                                .content(objectMapper
                                                .writeValueAsString(validCreatePayload("SKU-165-DUP", "MPN-165-B")))))
        ...
        void updateSku_returnsBadRequest() throws Exception {
                ...
                Map<String, Object> updatePayload = Map.of(
                                ...
                                "categoryId", UUID.fromString("00000000-0000-0000-0000-000000000001").toString(),
                                "sku", "SKU-CHANGED",
                                "mpn", "MPN-165-IMM",
                                "upc", "1000000000001",
                                "attributes", "{\"size\":\"XL\"}");
