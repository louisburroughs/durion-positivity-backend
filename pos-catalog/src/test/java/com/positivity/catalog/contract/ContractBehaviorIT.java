...
class ContractBehaviorIT extends BaseContractIntegrationTest {
    ...
    void testDeleteCatalog_HappyPath() throws Exception {
        ...
        mockMvc.perform(withAuth(delete("/v1/catalogs/{catalogId}", catalogId))).andExpect(status().isNoContent());

        mockMvc.perform(withAuth(get("/v1/catalogs/{catalogId}", catalogId))).andExpect(status().isNotFound());
    }
    ...
    void testCreateLocationOverride_ActiveWithinThreshold() throws Exception {
        ...
        mockMvc.perform(withAuth(
                        get("/v1/products/pricing/effective-price/{locationId}/{productId}", locationId, productId)))
                .andExpect(status().isOk())
    ...
    void testRejectLocationOverride_HappyPath() throws Exception {
        ...
        mockMvc.perform(withAuth(
                                ...
                                "ROLE_ADMIN")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(rejectionDecisionPayload(
                                version, approverUserId, "THRESHOLD_EXCEEDED", "Needs regional approval review")))
                .andExpect(status().isOk())
    ...
    void testGetCatalogById_NotFound() throws Exception {
        mockMvc.perform(withAuth(
                        get("/v1/catalogs/{catalogId}", UUID.fromString("00000000-0000-0000-0000-000000000001"))))
                .andExpect(status().isNotFound());
    }
    ...
    void testUpdateCatalog_NotFound() throws Exception {
        mockMvc.perform(withAuth(put(
                                "/v1/catalogs/{catalogId}", UUID.fromString("00000000-0000-0000-0000-000000000001")))
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void testDeleteCatalog_NotFound() throws Exception {
        mockMvc.perform(withAuth(
                        delete("/v1/catalogs/{catalogId}", UUID.fromString("00000000-0000-0000-0000-000000000001"))))
                .andExpect(status().isNotFound());
    }
    ...
    void testUnsupportedType_BadRequest() throws Exception {
        mockMvc.perform(withAuth(delete(
    ...
    void testCreateLocationOverride_MinMarginViolation() throws Exception {
        ...
        mockMvc.perform(withAuth(post("/v1/products/pricing/location-overrides"))
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(locationOverridePayload(
                                locationId,
                                productId,
                                UUID.fromString("00000000-0000-0000-0000-000000000001"),
                                100.00,
                                ...
                                75.00)))
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$.message").value(org.hamcrest.Matchers.containsString("MIN_MARGIN_VIOLATION")));
    }
    ...
    void testCreateLocationOverride_MaxDiscountViolation() throws Exception {
        ...
        mockMvc.perform(withAuth(post("/v1/products/pricing/location-overrides"))
                        ...
                        .content(locationOverridePayload(
                                ...
                                70.00)))
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$.message").value(org.hamcrest.Matchers.containsString("MAX_DISCOUNT_EXCEEDED")));
    }
    ...
    void testCreateLocationOverride_ProductNotFound() throws Exception {
        ...
        mockMvc.perform(withAuth(post("/v1/products/pricing/location-overrides"))
                        ...
                        .content(locationOverridePayload(
                                ...
                                95.00)))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$.message").value(org.hamcrest.Matchers.containsString("PRODUCT_NOT_FOUND")));
    }
    ...
    void testRejectLocationOverride_MissingNotes() throws Exception {
        ...
        mockMvc.perform(withAuth(
                ...
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$.message").value(org.hamcrest.Matchers.containsString("rejectionNotes")));
    }
    ...
    void testDeleteCatalog_RepeatedRequest() throws Exception {
        ...
        mockMvc.perform(withAuth(delete("/v1/catalogs/{catalogId}", catalogId))).andExpect(status().isNotFound());
    }
    ...
    void testEffectivePrice_IdempotentRead() throws Exception {
        ...
        upsertGuardrailPolicy(locationId, BigDecimal.valueOf(15), BigDecimal.valueOf(25), BigDecimal.valueOf(10));
        createLocationOverrideAndReturnResponse(
                locationId,
                productId,
                UUID.fromString("00000000-0000-0000-0000-000000000001"),
                100.00,
    ...
    private void upsertGuardrailPolicy(
            UUID locationId,
            BigDecimal minMarginPercent,
            BigDecimal maxDiscountPercent,
            BigDecimal autoApprovalThresholdPercent)
            throws Exception {
        mockMvc.perform(withAuth(post("/v1/products/pricing/guardrail-policies"), "ROLE_ADMIN")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(guardrailPolicyPayload(
                                locationId, minMarginPercent, maxDiscountPercent, autoApprovalThresholdPercent)))
                .andExpect(status().isOk());
    }

    private Map<String, Object> createLocationOverrideAndReturnResponse(
            UUID locationId,
            UUID productId,
        ...
        MvcResult result = mockMvc.perform(withAuth(post("/v1/products/pricing/location-overrides"), authorities)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(locationOverridePayload(
                                locationId, productId, createdByUserId, basePrice, cost, overridePrice)))
                .andExpect(status().isCreated())
                .andReturn();
    ...
    private String locationOverridePayload(
            UUID locationId, UUID productId, UUID createdByUserId, double basePrice, double cost, double overridePrice)
            throws Exception {
        return objectMapper.writeValueAsString(Map.of(
    ...
    private String rejectionDecisionPayload(
            Long version, UUID actorUserId, String rejectionReasonCode, String rejectionNotes) throws Exception {
        return objectMapper.writeValueAsString(Map.of(
                "version", version,
                "actorUserId", actorUserId,
