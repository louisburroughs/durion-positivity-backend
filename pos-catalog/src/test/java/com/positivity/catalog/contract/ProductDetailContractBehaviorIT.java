 ...
 *
 * <p>
 * Asserts future behavior for CAP-247 Story #16: live pricing and
 * availability data must be sourced from {@link PricingClient} and
 * {@link InventoryClient} respectively. Tests are intentionally RED because
 * {@code ProductDetailServiceImpl} currently uses hardcoded stubs and does not
 * invoke either client.
 *
 * <p>
...
class ProductDetailContractBehaviorIT extends BaseContractIntegrationTest {
    ...
    @Test
    @DisplayName("PD-003: Inventory service unavailable – returns MEDIUM confidence with UNAVAILABLE availability status")
