...
class PriceBookContractBehaviorIT extends BaseContractIntegrationTest {
    ...
    void resolvePriceFromGlobalRule() throws Exception {
        ...
        mockMvc.perform(withAuth(post("/v1/products/price-books/{priceBookId}/rules", priceBookId))
                        ...
                        .content(objectMapper.writeValueAsString(Map.of(
                                ...
                                "GLOBAL",
                                "pricingLogic",
                                "{\"amounts\":{\"USD\":\"59.9900\"},\"defaultCurrency\":\"USD\"}",
                                "conditionType",
                                "NONE",
                                "priority",
                                10,
    ...
    void skuRuleBeatsGlobalRule() throws Exception {
        ...
        mockMvc.perform(withAuth(post("/v1/products/price-books/{priceBookId}/rules", priceBookId))
                        ...
                        .content(objectMapper.writeValueAsString(Map.of(
                                ...
                                "GLOBAL",
                                "pricingLogic",
                                "{\"amounts\":{\"USD\":\"49.9900\"},\"defaultCurrency\":\"USD\"}",
                                "conditionType",
                                "NONE",
                                "priority",
                                1,
        ...
        mockMvc.perform(withAuth(post("/v1/products/price-books/{priceBookId}/rules", priceBookId))
                        ...
                        .content(objectMapper.writeValueAsString(Map.of(
                                ...
                                productId.toString(),
                                "pricingLogic",
                                "{\"amounts\":{\"USD\":\"39.9900\"},\"defaultCurrency\":\"USD\"}",
                                "conditionType",
                                "NONE",
                                "priority",
                                1,
    ...
    void rejectConflictingRule() throws Exception {
        ...
        mockMvc.perform(withAuth(post("/v1/products/price-books/{priceBookId}/rules", priceBookId))
                        ...
                        .content(objectMapper.writeValueAsString(Map.of(
                                ...
                                productId.toString(),
                                "pricingLogic",
                                "{\"amounts\":{\"USD\":\"29.9900\"},\"defaultCurrency\":\"USD\"}",
                                "conditionType",
                                "NONE",
                                "priority",
                                5,
        ...
        mockMvc.perform(withAuth(post("/v1/products/price-books/{priceBookId}/rules", priceBookId))
                        ...
                        .content(objectMapper.writeValueAsString(Map.of(
                                ...
                                productId.toString(),
                                "pricingLogic",
                                "{\"amounts\":{\"USD\":\"24.9900\"},\"defaultCurrency\":\"USD\"}",
                                "conditionType",
                                "NONE",
                                "priority",
                                10,
    ...
    void deactivateRuleFallsBackToMsrp() throws Exception {
        ...
        MvcResult ruleResult = mockMvc.perform(withAuth(
                                post("/v1/products/price-books/{priceBookId}/rules", priceBookId))
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(Map.of(
                                "targetType",
                                "GLOBAL",
                                "pricingLogic",
                                "{\"amounts\":{\"USD\":\"44.4400\"},\"defaultCurrency\":\"USD\"}",
                                "conditionType",
                                "NONE",
                                "priority",
                                2,
        ...
        Map<String, Object> createdRule = objectMapper.readValue(
                ruleResult.getResponse().getContentAsString(),
