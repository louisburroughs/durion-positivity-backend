 ...
 * {@link CatalogPostgresContainer}, with Hibernate {@code validate} and the pool connected as the
 ...
 *   <li>{@link SliceSupportConfig}: JPA auditing, a {@code Clock}, and a no-op cache manager
