...
/**
 * ArchUnit tests enforcing architecture rules for pos-catalog module.
 *
 * Enforces:
 ...
 */
@AnalyzeClasses(packages = "com.positivity.catalog", importOptions = ImportOption.DoNotIncludeTests.class)
public class ArchitectureTest {
    ...
    static final ArchRule spring_boot_application_should_be_in_root_package = classes()
            ...
            .should()
            .resideInAPackage("com.positivity.catalog")
            .andShould()
    ...
    static final ArchRule public_service_surface_should_not_depend_on_internal = noClasses()
            ...
            .should()
            .dependOnClassesThat()
            .resideInAPackage("com.positivity.catalog.internal..")
            .allowEmptyShould(true)
    ...
    @ArchTest
    static final ArchRule packages_should_be_free_of_cycles = slices().matching("com.positivity.catalog.internal.(*)..")
            .should()
            .beFreeOfCycles()
            .allowEmptyShould(true)
