 ...
 * Issue: CAP-218
 */
@WebMvcTest(controllers = WorkorderPickFacadeController.class, excludeFilters = @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, classes = GlobalExceptionHandler.class))
