...
class EstimateSearchServiceTest {
    ...
    void searchEstimates_byCustomerId_returnsEstimatesForThatCustomer() {
        ...
        when(estimateRepository.findByCustomerId(CUSTOMER_A, pageable)).thenReturn(new PageImpl<>(List.of(estimate)));
        when(estimateItemRepository.findByEstimate_IdAndDeletedFalse(any())).thenReturn(List.of());
    ...
    void searchEstimates_byVehicleId_returnsEstimatesForThatVehicle() {
        ...
        when(estimateRepository.findByVehicleId(VEHICLE_B, pageable)).thenReturn(new PageImpl<>(List.of(estimate)));
        when(estimateItemRepository.findByEstimate_IdAndDeletedFalse(any())).thenReturn(List.of());
    ...
    void searchEstimates_cancelledStatus_isIncluded() {
        ...
        when(estimateRepository.findByCustomerId(CUSTOMER_A, pageable)).thenReturn(new PageImpl<>(List.of(cancelled)));
        when(estimateItemRepository.findByEstimate_IdAndDeletedFalse(any())).thenReturn(List.of());
    ...
    void searchEstimates_noFilters_returnsAllEstimates() {
        ...
        when(estimateRepository.findAll(pageable)).thenReturn(new PageImpl<>(all, pageable, all.size()));
        when(estimateItemRepository.findByEstimate_IdAndDeletedFalse(any())).thenReturn(List.of());
    ...
    void searchEstimates_noMatchingEstimates_returnsEmptyPage() {
        ...
        when(estimateRepository.findByCustomerId(unknownCustomer, pageable)).thenReturn(new PageImpl<>(List.of()));
        when(estimateItemRepository.findByEstimate_IdAndDeletedFalse(any())).thenReturn(List.of());
