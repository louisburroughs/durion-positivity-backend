...
class WorkSessionServiceImplTest {
    ...
    void startSession_overlap_throwsWhenFlagTrueButNoPermission() {
        ...
        assertThatThrownBy(() -> workSessionService.startSession(req)).isInstanceOf(WorkSessionOverlapException.class);
    }
    ...
    void addBreakSegment_createsBreakSegment_onActiveSession() {
        ...
        AddBreakSegmentRequest request =
                AddBreakSegmentRequest.builder().breakType(BreakType.MEAL).build();
