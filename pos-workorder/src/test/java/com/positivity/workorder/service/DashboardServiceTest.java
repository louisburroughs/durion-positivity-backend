...
class DashboardServiceTest {
        ...
        void getDashboard_doubleBookedMechanic_returnsBlockingConflict() {
                ...
                Workorder wo1 = buildWorkorder(UUID.fromString("00000000-0000-0000-0000-000000000001"), "MECH-001",
                                null);
                Workorder wo2 = buildWorkorder(UUID.fromString("00000000-0000-0000-0000-000000000001"), "MECH-001",
                                null);
                when(workorderRepository.findByScheduledDateAndLocationId(any(), any()))
        ...
        void getDashboard_mechanicPtoOverlap_returnsBlockingConflict() {
                ...
                // scheduledDate
                Workorder wo = buildWorkorder(UUID.fromString("00000000-0000-0000-0000-000000000001"), "MECH-003",
                                null);
                when(workorderRepository.findByScheduledDateAndLocationId(any(), any()))
        ...
        void getDashboard_breakOverlapUnder15Min_returnsWarning() {
                ...
                Workorder wo = buildWorkorder(UUID.fromString("00000000-0000-0000-0000-000000000001"), "MECH-004",
                                null);
                when(workorderRepository.findByScheduledDateAndLocationId(any(), any()))
                                .thenReturn(List.of(wo));
        ...
        void getDashboard_mechanicClockedInForDifferentJob_returnsWarning() {
                ...
                Workorder wo = buildWorkorder(UUID.fromString("00000000-0000-0000-0000-000000000001"), "MECH-005",
                                null);
                when(workorderRepository.findByScheduledDateAndLocationId(any(), any()))
                                .thenReturn(List.of(wo));
        ...
        void getDashboard_bayDoubleBooked_returnsBlockingConflict() {
                ...
                Workorder wo1 = buildWorkorder(UUID.fromString("00000000-0000-0000-0000-000000000001"), "MECH-006",
                                sharedBayId);
                Workorder wo2 = buildWorkorder(UUID.fromString("00000000-0000-0000-0000-000000000001"), "MECH-007",
                                sharedBayId);
                when(workorderRepository.findByScheduledDateAndLocationId(any(), any()))
                                .thenReturn(List.of(wo1, wo2));
                when(peopleAvailabilityClient.fetchAvailability(any(), any()))
        ...
        void getDashboard_bayUnavailableClosed_returnsBlockingConflict() {
                ...
                Workorder wo = buildWorkorder(UUID.fromString("00000000-0000-0000-0000-000000000001"), "MECH-010",
                                bayId);
                when(workorderRepository.findByScheduledDateAndLocationId(any(), any()))
                                .thenReturn(List.of(wo));
                when(peopleAvailabilityClient.fetchAvailability(any(), any()))
        ...
        void getDashboard_mechanicAtDifferentLocation_returnsWarning() {
                ...
                Workorder wo = buildWorkorder(UUID.fromString("00000000-0000-0000-0000-000000000001"), "MECH-011",
                                null);
                when(workorderRepository.findByScheduledDateAndLocationId(any(), any()))
                                .thenReturn(List.of(wo));
        ...
        void getDashboard_bayUnavailableReserved_returnsBlockingConflict() {
                ...
                Workorder wo = buildWorkorder(UUID.fromString("00000000-0000-0000-0000-000000000001"), "MECH-013",
                                bayId);
                when(workorderRepository.findByScheduledDateAndLocationId(any(), any()))
                                .thenReturn(List.of(wo));
                when(peopleAvailabilityClient.fetchAvailability(any(), any()))
        ...
        void getDashboard_bayUnavailableUnderMaintenance_returnsBlockingConflict() {
                ...
                Workorder wo = buildWorkorder(UUID.fromString("00000000-0000-0000-0000-000000000001"), "MECH-014",
                                bayId);
                when(workorderRepository.findByScheduledDateAndLocationId(any(), any()))
                                .thenReturn(List.of(wo));
                when(peopleAvailabilityClient.fetchAvailability(any(), any()))
        ...
        void getDashboard_shopmgrBayData_populatesBayNameAndStatus() {
                ...
                Workorder wo = buildWorkorder(UUID.fromString("00000000-0000-0000-0000-000000000001"), "MECH-020",
                                bayId);
                when(workorderRepository.findByScheduledDateAndLocationId(any(), any()))
                                .thenReturn(List.of(wo));
                when(peopleAvailabilityClient.fetchAvailability(any(), any()))
        ...
        void getDashboard_breakReturnFarAway_noBreakOverlapConflict() {
                ...
                Workorder wo = buildWorkorder(UUID.fromString("00000000-0000-0000-0000-000000000001"), "MECH-040",
                                null);
                when(workorderRepository.findByScheduledDateAndLocationId(any(), any()))
                                .thenReturn(List.of(wo));
