...
/**
 * The tenancy tests' view of the shared {@link WorkorderPostgresContainer}: the container's
 * superuser owns the schema and runs Flyway, while the application pool connects as the non-owner
...
public abstract class PostgresTenancyTestBase {
    ...
    static final String APP_ROLE = WorkorderPostgresContainer.APP_ROLE;
    ...
    static DataSource ownerDataSource() {
        return WorkorderPostgresContainer.ownerDataSource();
    }
    ...
    static void datasource(DynamicPropertyRegistry registry) {
        WorkorderPostgresContainer.registerDataSourceProperties(registry);
    }
}
