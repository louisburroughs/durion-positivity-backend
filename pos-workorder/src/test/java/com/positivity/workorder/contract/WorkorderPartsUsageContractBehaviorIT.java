...
class WorkorderPartsUsageContractBehaviorIT extends BaseContractIntegrationTest {
    ...
    void testIssueParts_HappyPath() {
        ...
        Map<String, Object> issueRequest = Map.of(
                "workorderPartId", partId.toString(), "quantity", 2.0, "notes", "Issuing brake pads for service");
        ...
        List<WorkorderPartUsageEvent> events =
                usageEventRepository.findByWorkorderIdOrderByPerformedAtDesc(workorderId);
    ...
    void testIssueParts_Idempotency() {
        ...
        Map<String, Object> issueRequest = Map.of("workorderPartId", partId.toString(), "quantity", 2.0);
    ...
    void testConsumeParts_HappyPath() {
        ...
        Map<String, Object> consumeRequest =
                Map.of("workorderPartId", partId.toString(), "quantity", 3.0, "notes", "Used for brake service");
        ...
        long consumeEvents =
                events.stream().filter(e -> "CONSUME".equals(e.getEventType())).count();
    ...
    void testReturnParts_HappyPath() {
        ...
        Map<String, Object> returnRequest =
                Map.of("workorderPartId", partId.toString(), "quantity", 2.0, "notes", "Returned unused brake pads");
        ...
        List<WorkorderPartUsageEvent> events = usageEventRepository.findByWorkorderPartIdOrderByPerformedAtDesc(partId);
        long returnEvents =
                events.stream().filter(e -> "RETURN".equals(e.getEventType())).count();
    ...
    void testReturnParts_Idempotency() {
        ...
        Map<String, Object> returnRequest = Map.of("workorderPartId", partId.toString(), "quantity", 1.0);
    ...
    void testGetUsageHistory_Works() {
        ...
        assertThat(events.get(0).getPerformedAt())
                .isAfterOrEqualTo(events.get(1).getPerformedAt());
        assertThat(events).extracting(WorkorderPartUsageEvent::getEventType).contains("ISSUE", "CONSUME", "RETURN");
    }
