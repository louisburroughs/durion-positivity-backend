...
class CrmReferenceIdContractBehaviorIT extends BaseContractIntegrationTest {
    ...
    void ac2_promoteEstimate_workorder_containsCrmPartyId() {
        ...
        // path.
        UUID estimateId = seedApprovedEstimateWithCrmFields(CRM_PARTY_ID, CRM_VEHICLE_ID, List.of(CRM_CONTACT_ID));
     ...
     */
    private static String buildEstimatePayload(String crmPartyId, String crmVehicleId, List<String> crmContactIds) {
        ...
        String contactIdsJson = crmContactIds.isEmpty() ? "[]" : "[\"" + String.join("\",\"", crmContactIds) + "\"]";
        ...
        return String.format(
                "{\"customerId\":\"%s\",\"vehicleId\":\"%s\",\"locationId\":\"%s\","
                        ...
                        + "\"crmVehicleId\":\"%s\","
                        + "\"crmContactIds\":%s}",
                customerId, vehicleId, locationId, crmPartyId, crmVehicleId, contactIdsJson);
    }
     ...
     * API flow.
     */
    private UUID seedApprovedEstimateWithCrmFields(String crmPartyId, String crmVehicleId, List<String> crmContactIds) {
