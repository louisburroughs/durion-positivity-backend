...
class WorkexecLaborPerformedContractBehaviorIT extends AbstractWorkexecContractBehaviorIT {
    ...
    void replayWithSameIdempotencyKeyReturnsOkAndNoDuplicate() throws Exception {
        ...
        String firstLaborPerformedId = objectMapper
                .readTree(firstResponseBody)
    ...
    void missingIdempotencyKeyReturnsBadRequest() throws Exception {
        ...
        Map<String, Object> payload = buildLaborPerformedPayload(
                workorder.getId(), technicianId, "te-" + UUID.fromString("00000000-0000-0000-0000-000000000001"));
    ...
    private Map<String, Object> buildLaborPerformedPayload(UUID workorderId, UUID technicianId, String timeEntryId) {
        return WorkexecContractPayloads.laborPerformedPayload(
                workorderId, technicianId, BigDecimal.valueOf(1.5), timeEntryId);
    }
}
