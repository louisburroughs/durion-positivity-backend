...
class WorkorderCompletionContractBehaviorIT extends BaseContractIntegrationTest {
    ...
    void completeWorkorder_ShouldFinalizeBillableSnapshotAndTransitionState() {
        ...
        Map<String, Object> request = Map.of(
                "userId", SYSTEM_USER_ID.toString(), "completionNotes", "All required repair operations completed");
        ...
        List<WorkorderSnapshot> snapshots =
                workorderSnapshotRepository.findByWorkorder_IdOrderByCapturedAtDesc(workorderId);
        assertThat(snapshots).extracting(WorkorderSnapshot::getSnapshotType).contains("BILLABLE_SCOPE_FINALIZED");
        ...
        try {
            ...
            Map<String, Object> payload = objectMapper.readValue(finalizedSnapshot.getSnapshotData(), Map.class);
            assertThat(payload)
                    ...
                    .containsEntry(
                            "customerAccountId", workorder.getCustomerId().toString())
        ...
        List<AuditEvent> auditEvents =
                auditEventRepository.findByEntityTypeAndEntityIdOrderByEventTimestampDesc("Workorder", workorderId);
        assertThat(auditEvents).extracting(AuditEvent::getEventType).contains("StateTransition");
    }
    ...
    void completeWorkorder_ShouldBlockWhenItemsNotTerminal() {
        ...
        Map<String, Object> request =
                Map.of("userId", SYSTEM_USER_ID.toString(), "completionNotes", "Attempt completion with open items");
    ...
    void reopenWorkorder_ShouldRequireReason() {
        ...
        Map<String, Object> request = Map.of("userId", SYSTEM_USER_ID.toString(), "reopenReason", "   ");
    ...
    void reopenWorkorder_ShouldMarkReopenedAndAudit() {
        ...
        Map<String, Object> request = Map.of(
                "userId", SYSTEM_USER_ID.toString(), "reopenReason", "Correcting part quantity before invoicing");
        ...
        List<WorkorderSnapshot> snapshots =
                workorderSnapshotRepository.findByWorkorder_IdOrderByCapturedAtDesc(workorderId);
        assertThat(snapshots).extracting(WorkorderSnapshot::getSnapshotType).contains("BILLABLE_SCOPE_SUPERSEDED");

        List<AuditEvent> auditEvents =
                auditEventRepository.findByEntityTypeAndEntityIdOrderByEventTimestampDesc("Workorder", workorderId);
        assertThat(auditEvents).extracting(AuditEvent::getEventType).contains("WORKORDER_REOPENED");
    }
    ...
    void reopenWorkorder_ShouldRejectNonCompletedWorkorders() {
        ...
        Map<String, Object> request =
                Map.of("userId", SYSTEM_USER_ID.toString(), "reopenReason", "Attempting invalid reopen");
