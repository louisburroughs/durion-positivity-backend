...
class WorkorderPartAdjustmentsContractBehaviorIT extends BaseContractIntegrationTest {
    ...
    void testSubstitutePart_HappyPath() {
        ...
        UUID originalPartId =
                workorderPartRepository.findByWorkorderId(workorderId).get(0).getId();
        ...
        Map<String, Object> substituteRequest = Map.of(
                "originalPartId",
                originalPartId.toString(),
                "substitutePartId",
                substitutePartId.toString(),
                "reason",
                "Original part out of stock",
                "notes",
                "Used equivalent premium part");
        ...
        List<WorkorderPartAdjustmentEvent> events =
                adjustmentEventRepository.findByWorkorderIdOrderByPerformedAtDesc(workorderId);
        ...
        WorkorderPart originalPart =
                workorderPartRepository.findById(originalPartId).orElseThrow();
    ...
    void testSubstitutePart_SubstituteQuantitiesCorrect() {
        ...
        UUID workorderId = seedWorkorderWithPart();
        WorkorderPart originalPart =
                workorderPartRepository.findByWorkorderId(workorderId).get(0);
    ...
    void testReturnUnused_HappyPath() {
        ...
        UUID workorderId = seedWorkorderWithPartiallyConsumedPart(BigDecimal.valueOf(10.0), BigDecimal.valueOf(6.0));
        UUID partId =
                workorderPartRepository.findByWorkorderId(workorderId).get(0).getId();
        ...
        Map<String, Object> returnRequest = Map.of(
                ...
                3.0,
                "reason",
                "Part not needed for this service",
                "notes",
    ...
    void testReturnUnused_Idempotency() {
        ...
        Map<String, Object> returnRequest =
                Map.of("workorderPartId", partId.toString(), "quantity", 2.0, "reason", "Not needed");
    ...
    void testCorrectQuantity_HappyPath() {
        ...
        Map<String, Object> correctRequest = Map.of(
                ...
                5.0,
                "reason",
                "Data entry error - should be 5 units",
                "notes",
                "Corrected after invoice review");
    ...
    void testCorrectQuantity_Idempotency() {
        ...
        Map<String, Object> correctRequest =
                Map.of("workorderPartId", partId.toString(), "newQuantity", 4.0, "reason", "Correction");
    ...
    private UUID seedWorkorderWithMultipleAdjustments() {
        ...
        Map<String, Object> returnRequest =
                Map.of("workorderPartId", originalPartId.toString(), "quantity", 2.0, "reason", "Second adjustment");
        ...
        Map<String, Object> correctRequest =
                Map.of("workorderPartId", originalPartId.toString(), "newQuantity", 5.0, "reason", "Third adjustment");
    ...
    private void setPerformedAtForAdjustment(UUID workorderId, String adjustmentType, Instant performedAt) {
        WorkorderPartAdjustmentEvent event =
                adjustmentEventRepository.findByWorkorderIdOrderByPerformedAtDesc(workorderId).stream()
