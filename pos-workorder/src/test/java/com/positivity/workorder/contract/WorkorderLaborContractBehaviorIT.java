...
class WorkorderLaborContractBehaviorIT extends BaseContractIntegrationTest {
    ...
    void testStartLaborSession_HappyPath() {
        ...
        List<WorkorderLaborEntry> entries = laborEntryRepository.findByWorkorder_IdOrderByStartTimeDesc(workorderId);
    ...
    void testStartLaborSession_Idempotency() {
        ...
        Map<String, Object> startRequest =
                Map.of("technicianId", testTechnicianId.toString(), "notes", "First attempt");
    ...
    void testStartLaborSession_InvalidStatus() {
        ...
        Map<String, Object> startRequest = Map.of("technicianId", testTechnicianId.toString());
    ...
    void testStopLaborSession_HappyPath() {
        ...
        UUID entryId = laborEntryRepository
    ...
    void testStopLaborSession_Idempotency() {
        ...
        assertThat(secondHoursWorked).isEqualByComparingTo(firstHoursWorked.setScale(2, RoundingMode.HALF_UP));
    }
    ...
    void testGetLaborHistory_NewestFirst() {
        ...
        List<String> startTimes = givenWithGatewayAuth()
                ...
                .extract()
                .jsonPath()
                .getList("startTime", String.class);
