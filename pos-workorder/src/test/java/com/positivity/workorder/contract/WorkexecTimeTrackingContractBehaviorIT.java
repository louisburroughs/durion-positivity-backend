...
class WorkexecTimeTrackingContractBehaviorIT extends BaseContractIntegrationTest {
    ...
    void laborPerformedCreateAndReplay() {
        Workorder workorder = seedWorkorder(
                WorkorderStatus.WORK_IN_PROGRESS, UUID.fromString("00000000-0000-0000-0000-000000000001"));
        ...
        Map<String, Object> payload = WorkexecContractPayloads.laborPerformedPayload(
                workorder.getId(), technicianId, BigDecimal.valueOf(1.5), "te-123");
    ...
    void laborPerformedRejectsBlockedWorkorderStatus() {
        Workorder workorder =
                seedWorkorder(WorkorderStatus.CANCELLED, UUID.fromString("00000000-0000-0000-0000-000000000001"));
        ...
        givenWithGatewayAuth()
                .contentType(ContentType.JSON)
                .header("Idempotency-Key", "cap121-blocked-" + UUID.fromString("00000000-0000-0000-0000-000000000001"))
                .body(payload)
                .when()
                .post("/v1/workexec/labor-performed")
                .then()
    ...
    void jobTimeTotalsAggregation() {
        ...
        seedCompletedLaborEntry(workorder, technicianId, LocalDateTime.of(2026, 2, 16, 10, 0), new BigDecimal("1.50"));
        seedCompletedLaborEntry(workorder, technicianId, LocalDateTime.of(2026, 2, 16, 12, 0), new BigDecimal("0.50"));
        ...
        assertThat(laborEntryRepository.findByWorkorder_IdOrderByStartTimeDesc(workorder.getId()))
                .hasSize(2);
    }
    ...
    private void seedCompletedLaborEntry(
            Workorder workorder, UUID technicianId, LocalDateTime endTimeUtc, BigDecimal hoursWorked) {
