 ...
 * {@link WorkorderPostgresContainer}, with Hibernate {@code validate} and the pool connected as the
 ...
 *   <li>no JPA auditing: {@code JpaAuditingConfig} is an application {@code @Configuration} the
