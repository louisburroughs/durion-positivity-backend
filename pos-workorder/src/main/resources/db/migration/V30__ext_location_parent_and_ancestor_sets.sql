-- ADR-0061 §1–§2 (#1878): location-scope hierarchy on the ext_location replica.
--
-- 1. Typed location-parent edges carried on location.location.updated facts (ADR-0044 §6),
--    mirroring pos-inventory's and pos-people's ext_location_parent. One parent per
...
--    HOME_OFFICE/HEADQUARTERS/REGION/DISTRICT/PHYSICAL/ORGANIZATIONAL/SHIPPING. Both are inclusive of the
--    location itself so a directly assigned node matches by the same rule.
--
