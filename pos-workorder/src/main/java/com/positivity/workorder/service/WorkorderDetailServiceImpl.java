...
public class WorkorderDetailServiceImpl implements WorkorderDetailService {
    ...
    public @NonNull WorkorderDetailResponse getWorkorderDetail(
        ...
        WorkorderDetailResponse.WorkorderDetailResponseBuilder builder = WorkorderDetailResponse.builder()
                ...
                .workorderNumber(generateWorkorderNumber(workorder.getId())) // Placeholder - implement sequence lookup
                                                                             // if needed
                ...
                .createdAt(workorder.getUpdatedAt().atZone(java.time.ZoneId.systemDefault()).toInstant()) // Approximate
                                                                                                          // creation
                                                                                                          // time
                ...
                .assignedTechnicianId(currentAssignment.map(TechnicianAssignment::getTechnicianId).orElse(null))
                .assignedTechnicianName(currentAssignment.map(ta -> "Technician-" + ta.getTechnicianId()).orElse(null))
