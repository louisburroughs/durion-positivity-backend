...
public interface WorkSessionService {
     ...
     */
    @NonNull WorkSessionResponse startSession(@NonNull StartWorkSessionRequest request);
     ...
     */
    @NonNull WorkSessionResponse stopSession(@NonNull UUID workSessionId, @NonNull StopWorkSessionRequest request);
     ...
     */
    @NonNull BreakSegmentResponse addBreakSegment(@NonNull UUID workSessionId, @NonNull AddBreakSegmentRequest request);
     ...
     */
    @NonNull BreakSegmentResponse stopBreakSegment(@NonNull UUID workSessionId, @NonNull UUID breakSegmentId);
}
