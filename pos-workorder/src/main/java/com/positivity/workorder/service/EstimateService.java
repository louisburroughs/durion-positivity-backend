...
public interface EstimateService {
    ...
    EstimateResponse approveEstimate(
            UUID estimateId,
            UUID customerId,
     ...
     */
    EstimateResponse updateEstimateFinancials(
     ...
     */
    EstimateItemResponse addEstimateItem(UUID estimateId, AddEstimateItemRequest request, String username);
     ...
     */
    EstimateItemResponse updateEstimateItem(UUID estimateId, UUID itemId, UpdateEstimateItemRequest request);
     ...
     */
    EstimateSnapshotResponse createEstimateSnapshot(UUID estimateId, String username, String notes);
