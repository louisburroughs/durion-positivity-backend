...
public class WorkSessionController {
    ...
    @Operation(summary = "Start a work session", description = "Technician starts a work session on a work order. "
    ...
    @Operation(summary = "Stop a work session", description = "Technician stops an active work session. "
    ...
    @Operation(summary = "Start a break segment", description = "Technician records the start of a break within an active work session.")
    ...
    @Operation(summary = "Stop a break segment", description = "Technician records the end of a break segment within an active work session.")
