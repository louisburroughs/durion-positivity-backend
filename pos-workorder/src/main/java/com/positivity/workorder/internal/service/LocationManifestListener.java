...
public class LocationManifestListener {
    ...
    @Value("${workorder.kafka.location-commands-topic:location.commands.v1}")
    ...
    @KafkaListener(
            topics = "${workorder.kafka.location-manifest-topic:location.manifest.v1}",
            groupId = "${workorder.kafka.location-manifest-consumer-group:pos-workorder-location-manifests}")
