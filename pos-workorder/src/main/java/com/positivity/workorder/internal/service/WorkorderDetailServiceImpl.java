...
public class WorkorderDetailServiceImpl implements WorkorderDetailService {
        ...
        public @NonNull WorkorderDetailResponse getWorkorderDetail(
                ...
                List<WorkorderServiceResponse> serviceResponses = buildServiceResponses(workorder.getServices(),
                                capabilities.isCanViewFinancials());

                // Build part line items
                List<WorkorderPartResponse> partResponses = buildPartResponses(workorder.getServices(),
                                capabilities.isCanViewFinancials());
