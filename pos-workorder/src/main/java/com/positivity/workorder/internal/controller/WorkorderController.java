...
public class WorkorderController {
    ...
    @Operation(
            ...
            description = """
                    ...
                    replication.
                    Returns 404 when the workorder does not exist, and 400 when the status is not DRAFT or the \
                    customerId in the request does not match the workorder's own customer.
                    """)
