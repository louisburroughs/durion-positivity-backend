...
@Slf4j
@Component
public class PickEventTypeInitializer implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        try {
            initializerSupport.registerEventTypes(PickEventTypes.ALL_EVENT_TYPES, this::registerViaHttp);
        } catch (Exception e) {
            log.warn(
