...
public class WorkorderServiceLine extends TenantScopedEntity {
    @Id
    @GeneratedValue
    @UUIDv7Id
    ...
    // Guide-time snapshot carried over at promotion (#1569, sourcing plan §6.3): quantity is
    // the agreed hours, guideHours is what the guide published, and the overlap metadata is
    // what keeps the workorder's estimatedLaborHours sum honest after later guide revisions.
    ...
    // Comma-separated Durion operation codes included in this line's guide hours.
