...
public class WorkorderLaborServiceImpl implements WorkorderLaborService {
        ...
        public WorkorderLaborEntry startLaborSession(
                        ...
                        if (existingId.isPresent()) {
                                ...
                                return laborRepository.findById(existingId.get())
                                                .orElseThrow(() -> new NoSuchElementException(
                                                                LABOR_ENTRY_NOT_FOUND + existingId.get()));
                        }
                }
                ...
                WorkorderServiceLine workorderService = workorderServiceRepository.findById(serviceId)
                                .orElseThrow(() -> new NoSuchElementException(
                                                "Workorder service not found: " + serviceId));
                ...
                if (idempotencyKey != null && !idempotencyKey.isBlank()) {
                        idempotencyService.registerLaborKey(IDEMPOTENCY_OPERATION_LABOR_START, idempotencyKey,
                                        saved.getId());
                }
        ...
        public WorkorderLaborEntry stopLaborSession(
                ...
                // Register idempotency key if provided
                if (idempotencyKey != null && !idempotencyKey.isBlank()) {
                        idempotencyService.registerLaborKey(IDEMPOTENCY_OPERATION_LABOR_STOP, idempotencyKey,
                                        saved.getId());
                }
        ...
        public WorkorderLaborEntry adjustLaborHours(
                ...
                // Register idempotency key if provided
                if (idempotencyKey != null && !idempotencyKey.isBlank()) {
                        idempotencyService.registerLaborKey(IDEMPOTENCY_OPERATION_LABOR_ADJUST, idempotencyKey,
                                        saved.getId());
                }
