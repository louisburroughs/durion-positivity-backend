...
public class CustomerManifestListener {
    ...
    @Value("${workorder.kafka.customer-commands-topic:customer.commands.v1}")
    ...
    @KafkaListener(
            topics = "${workorder.kafka.customer-manifest-topic:customer.manifest.v1}",
            groupId = "${workorder.kafka.customer-manifest-consumer-group:pos-workorder-customer-manifests}")
