 ...
 * contributor in {@code /actuator/health} plus the {@code workorder.outbox.pending} and
 * {@code workorder.outbox.oldest.age.seconds} gauges that the domain-events Grafana alerts fire on.
 *
