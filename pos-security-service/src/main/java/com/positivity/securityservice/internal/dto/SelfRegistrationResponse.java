...
public record SelfRegistrationResponse(
        @Schema(description = "Created user identifier") UUID userId,
        ...
        @Nullable @Schema(description = "Summary of CRM person search candidates")
        CrmMatchSummaryDto crmMatchSummary,

        @Nullable @Schema(description = "Idempotency key echoed back when the caller supplied one")
