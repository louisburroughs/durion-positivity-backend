...
public record TokenPairResponse(
        @JsonProperty("accessToken") @Schema(description = "Short-lived JWT access token (1 hour expiration)", example = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...") String accessToken,

        @JsonProperty("refreshToken") @Schema(description = "Long-lived JWT refresh token (7 days expiration)", example = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...") String refreshToken) {
    /**
