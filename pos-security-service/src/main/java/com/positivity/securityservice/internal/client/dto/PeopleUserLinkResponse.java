...
public record PeopleUserLinkResponse(
        ...
        @Schema(
                description = "Linked user identifier",
        ...
        @Schema(
                description = "Timestamp the link was created",
                example = "2026-01-15T09:30:00Z",
                requiredMode = Schema.RequiredMode.REQUIRED)
        Instant createdAt,

        @Schema(
                description = "Actor that created the link",
                example = "system",
                requiredMode = Schema.RequiredMode.NOT_REQUIRED)
        String createdBy,

        @Schema(
                description = "Notes recorded with the link",
                example = "Created during self-registration",
                requiredMode = Schema.RequiredMode.NOT_REQUIRED)
        String notes) {}
