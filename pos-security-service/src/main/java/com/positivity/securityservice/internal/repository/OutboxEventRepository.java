...
public interface OutboxEventRepository extends JpaRepository<OutboxEvent, UUID> {
    ...
    /** Unpublished backlog depth — drives the {@code security.outbox.pending} gauge (#1458). */
    long countByPublishedAtIsNull();

    /**
     * Oldest unpublished row (drain head) — drives the {@code security.outbox.oldest.age.seconds} gauge
