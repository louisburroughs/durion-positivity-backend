...
public class RoleController {
    ...
    public ResponseEntity<Void> revokeRoleAssignment(
            ...
            @Parameter(description = "Effective end date for revocation. Supports past, present, or future dates. Defaults to current date", example = "2026-02-16") @RequestParam(required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate endDate) {
