...
public class RoleController {
        ...
        @ApiResponse(responseCode = "400", description = "Invalid role payload", content = @Content(schema = @Schema(implementation = ApiError.class)))
        ...
        @ApiResponse(responseCode = "400", description = "Invalid grant request", content = @Content(schema = @Schema(implementation = ApiError.class)))
        @ApiResponse(responseCode = "404", description = "Role or permission not found", content = @Content(schema = @Schema(implementation = ApiError.class)))
        ...
        public ResponseEntity<List<RoleAssignmentDto>> getUserRoleAssignments(
                ...
                List<RoleAssignmentDto> assignments = roleManagementService.getAssignmentsForUser(userId,
                                includeHistory);
        ...
        public ResponseEntity<Boolean> checkUserPermission(
                ...
                boolean hasPermission = roleManagementService.userHasPermission(userId, permission,
                                locationId != null ? locationId : "GLOBAL");
