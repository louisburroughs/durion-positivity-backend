...
public class JwtController {
    ...
    @Operation(
            ...
            description = "Authenticate and receive both access token (1-hour) and refresh token (7-day). "
    ...
    @Operation(
            summary = "Extract authorities from JWT token (deprecated)",
            description =
                    "Compatibility endpoint for legacy tokens. New token issuance does not include an authorities claim.")
