...
/**
 * Consumer-side reconciliation for the people-contact identity replicas (amended ADR-0043 reconciliation, #876).
 *
...
public class PeopleContactManifestListener {
    ...
    @KafkaListener(
            topics = "${pos.security-service.kafka.people-contact-manifest-topic:people-contact.manifest.v1}",
            groupId =
                    "${pos.security-service.kafka.people-contact-manifest-consumer-group:pos-security-people-contact-manifests}")
