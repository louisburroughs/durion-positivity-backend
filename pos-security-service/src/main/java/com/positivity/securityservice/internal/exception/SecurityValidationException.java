 ...
 * {@code GlobalExceptionHandler} maps it to {@code 400 INVALID_REQUEST} (ADR-0017 §1), echoing
 * the message.
 *
 ...
 * server-side defects back to the client as a {@code 400 INVALID_REQUEST}, leaking internal
