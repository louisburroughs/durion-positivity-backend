...
public record SelfRegistrationReviewCaseResponse(
        @Schema(description = "Review case identifier") UUID caseId,
        @Schema(description = "Case type") SelfRegistrationCaseType caseType,
        @Schema(description = "Case status") SelfRegistrationCaseStatus status,
        ...
        @Schema(description = "Submitted email address") String email,
        ...
        @Schema(description = "Case creation timestamp") Instant createdAt,
        @Schema(description = "Case last-updated timestamp") Instant updatedAt,
