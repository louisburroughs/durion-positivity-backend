...
public interface RoleAuthorityService {
    ...
    String ROLE_ACCOUNTING_ASSOCIATE = "ACCOUNTING_ASSOCIATE";
    String ROLE_ACCOUNT_MANAGER = "ACCOUNT_MANAGER";
    String ROLE_LOCATION_MANAGER = "LOCATION_MANAGER";
    String ROLE_SERVICE_ADVISOR = "SERVICE_ADVISOR";
