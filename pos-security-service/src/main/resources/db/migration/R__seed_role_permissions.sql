...
-- file and the bulk-load grants file (see SCOPE below).
--
-- POLICY
...
--   during pos-security-service's own boot, before the other modules have registered anything — was
--   always a snapshot that drifted from the registries it mirrors.
--   The guard in section 4 raises on a role it cannot resolve, so a grant left here for a moved role
--   fails the migration rather than silently doing nothing. Keep this file and the guard in step.
...
-- * SUPPORT (ADR-0062 section 7, plan WS2b-4, decided 2026-09-10) is the fixed
--   tenant role a platform operator's impersonation token carries: a 15-minute,
--   no-refresh token minted by pos-security-service with tid = the target tenant
--   and act = the operator. It is a floor role so that it reaches the platform
--   role template (R__seed_tenant_template.sql) and, through provisioning, every
--   tenant. It holds the read-only surface of the six floor roles' domains — every
--   *:*:view / *:*:read permission they hold plus location:read — and nothing
--   else: no write, no platform:*, and deliberately not the assistant baseline
--   (an impersonation token is a support read, not a chat session), not the MCP
...
FROM (VALUES
    ...
    ('catalog:labor_standard:import', 'catalog', 'labor_standard', 'import', 504),
    ('catalog:labor_standard:manage', 'catalog', 'labor_standard', 'manage', 500),
    ('catalog:labor_standard:view', 'catalog', 'labor_standard', 'view', 501),
    ('catalog:labor_time:resolve', 'catalog', 'labor_time', 'resolve', 505),
    ...
    ('catalog:service:ingest', 'catalog', 'service', 'ingest', 516),
    ('catalog:service_package:manage', 'catalog', 'service_package', 'manage', 513),
    ('catalog:service_package:view', 'catalog', 'service_package', 'view', 514),
    ('catalog:service_requirement:manage', 'catalog', 'service_requirement', 'manage', 532),
    ...
    ('catalog:tread_design:resolve', 'catalog', 'tread_design', 'resolve', 508),
    ...
    ('crm:fact:replay', 'crm', 'fact', 'replay', 518),
    ...
    ('inventory:putaway_rule:manage', 'inventory', 'putaway_rule', 'manage', 491),
    ('inventory:putaway_rule:view', 'inventory', 'putaway_rule', 'view', 492),
    ...
    ('invoice:invoice:view', 'invoice', 'invoice', 'view', 494),
    ('invoice:manage', 'invoice', '', 'manage', 82),
    ('invoice:payment:override', 'invoice', 'payment', 'override', 540),
    ('invoice:payment:refund', 'invoice', 'payment', 'refund', 536),
    ('invoice:payment:void', 'invoice', 'payment', 'void', 537),
    ('invoice:receipt:generate', 'invoice', 'receipt', 'generate', 538),
    ('invoice:receipt:reprint_override', 'invoice', 'receipt', 'reprint_override', 541),
    ('invoice:refund:issue_manual', 'invoice', 'refund', 'issue_manual', 539),
    ...
    ('mcp:eval_trace:view', 'mcp', 'eval_trace', 'view', 507),
    ...
    ('people:employee:activation', 'people', 'employee', 'activation', 119),
    ('people:employee:edit', 'people', 'employee', 'edit', 118),
    ('people:employee:view', 'people', 'employee', 'view', 116),
    ('people:employee_pii:view', 'people', 'employee_pii', 'view', 519),
    ('people:jobRole:manage', 'people', 'jobRole', 'manage', 534),
    ('people:jobRole:view', 'people', 'jobRole', 'view', 535),
    ('people:self:view', 'people', 'self', 'view', 517),
    ...
    ('people:timeEntry:view', 'people', 'timeEntry', 'view', 493),
    ...
    ('people:timePeriod:create', 'people', 'timePeriod', 'create', 488),
    ('people:timePeriod:transition', 'people', 'timePeriod', 'transition', 489),
    ('platform:account:create', 'platform', 'account', 'create', 520),
    ('platform:account:read', 'platform', 'account', 'read', 521),
    ('platform:account:update', 'platform', 'account', 'update', 522),
    ('platform:tenant:create', 'platform', 'tenant', 'create', 523),
    ('platform:tenant:decommission', 'platform', 'tenant', 'decommission', 524),
    ('platform:tenant:reactivate', 'platform', 'tenant', 'reactivate', 525),
    ...
    ('platform:tenant:impersonate', 'platform', 'tenant', 'impersonate', 530),
    ...
    ('pricing:labor_rate:view', 'pricing', 'labor_rate', 'view', 511),
    ...
    ('shop:conflict:override', 'shop', 'conflict', 'override', 531),
    ('shop:dashboard:view', 'shop', 'dashboard', 'view', 506),
    ...
    ('supplier:stockavailability:read', 'supplier', 'stockavailability', 'read', 502),
    ...
    ('tax:rates:view', 'tax', 'rates', 'view', 490),
    ...
    ('workorder:labor_intelligence:view', 'workorder', 'labor_intelligence', 'view', 515),
    ('workorder:note:add', 'workorder', 'note', 'add', 498),
    ('workorder:note:view', 'workorder', 'note', 'view', 499),
    ...
    ('workorder:position:assign', 'workorder', 'position', 'assign', 533),
...
FROM (VALUES
    ...
    ('ADMIN', 'catalog:labor_standard:import'),
    ('ADMIN', 'catalog:labor_standard:manage'),
    ('ADMIN', 'catalog:labor_standard:view'),
    ('ADMIN', 'catalog:labor_time:resolve'),
    ...
    ('ADMIN', 'catalog:service:ingest'),
    ('ADMIN', 'catalog:service_package:manage'),
    ('ADMIN', 'catalog:service_package:view'),
    ('ADMIN', 'catalog:service_requirement:manage'),
    ...
    ('ADMIN', 'inventory:putaway_rule:manage'),
    ('ADMIN', 'inventory:putaway_rule:view'),
    ...
    ('ADMIN', 'invoice:payment:override'),
    ('ADMIN', 'invoice:payment:refund'),
    ('ADMIN', 'invoice:payment:void'),
    ('ADMIN', 'invoice:receipt:generate'),
    ('ADMIN', 'invoice:receipt:reprint_override'),
    ('ADMIN', 'invoice:refund:issue_manual'),
    ...
    ('ADMIN', 'people:employee:activation'),
    ('ADMIN', 'people:employee:edit'),
    ('ADMIN', 'people:employee:view'),
    ('ADMIN', 'people:employee_pii:view'),
    ('ADMIN', 'people:jobRole:manage'),
    ('ADMIN', 'people:jobRole:view'),
    ('ADMIN', 'people:self:view'),
    ...
    ('ADMIN', 'people:timePeriod:create'),
    ('ADMIN', 'people:timePeriod:transition'),
    ('ADMIN', 'pricing:base_price:create'),
    ('ADMIN', 'pricing:labor_rate:manage'),
    ('ADMIN', 'pricing:labor_rate:quote'),
    ('ADMIN', 'pricing:labor_rate:view'),
    ...
    ('ADMIN', 'supplier:stockavailability:read'),
    ...
    ('ADMIN', 'workorder:labor_intelligence:view'),
    ('ADMIN', 'workorder:note:add'),
    ('ADMIN', 'workorder:note:view'),
    ...
    ('ADMIN', 'workorder:position:assign'),
    ...
    ('DISPATCHER', 'people:self:view'),
    ('DISPATCHER', 'people:skill:view'),
    ...
    ('SHOP_MANAGER', 'invoice:payment:override'),
    ('SHOP_MANAGER', 'invoice:payment:refund'),
    ('SHOP_MANAGER', 'invoice:payment:void'),
    ('SHOP_MANAGER', 'invoice:receipt:generate'),
    ('SHOP_MANAGER', 'invoice:receipt:reprint_override'),
    ('SHOP_MANAGER', 'invoice:refund:issue_manual'),
    ...
    ('SHOP_MANAGER', 'people:employee_pii:view'),
    ('SHOP_MANAGER', 'people:self:view'),
    ('SHOP_MANAGER', 'people:skill:view'),
    ('SHOP_MANAGER', 'shop:bay:assign'),
    ('SHOP_MANAGER', 'shop:conflict:override'),
    ('SHOP_MANAGER', 'shop:dashboard:view'),
    ...
    ('SHOP_MANAGER', 'workorder:note:add'),
    ('SHOP_MANAGER', 'workorder:note:view'),
    ('SHOP_MANAGER', 'workorder:position:assign'),
    ...
    ('SUPPORT', 'accounting:analytics:view'),
    ('SUPPORT', 'accounting:ap:view'),
    ('SUPPORT', 'accounting:coa:view'),
    ('SUPPORT', 'accounting:credit-memo:read'),
    ('SUPPORT', 'accounting:customer-credit:view'),
    ('SUPPORT', 'accounting:default-mapping:view'),
    ('SUPPORT', 'accounting:events:view'),
    ('SUPPORT', 'accounting:export:view'),
    ('SUPPORT', 'accounting:je:view'),
    ('SUPPORT', 'accounting:mapping-key:view'),
    ('SUPPORT', 'accounting:period:view'),
    ...
    ('SUPPORT', 'catalog:location_price_override:read'),
    ('SUPPORT', 'catalog:msrp:read'),
    ('SUPPORT', 'catalog:non_inventory:view'),
    ('SUPPORT', 'catalog:price_book:read'),
    ('SUPPORT', 'catalog:product:view'),
    ('SUPPORT', 'catalog:product_uom:view'),
    ('SUPPORT', 'catalog:service_package:view'),
    ('SUPPORT', 'catalog:service_type:view'),
    ('SUPPORT', 'catalog:substitution_group:view'),
    ('SUPPORT', 'catalog:supplier_cost:read'),
    ('SUPPORT', 'catalog:tread_design:view'),
    ('SUPPORT', 'catalog:uom_conversion:view'),
    ('SUPPORT', 'crm:consent:view'),
    ('SUPPORT', 'crm:contact:view'),
    ('SUPPORT', 'crm:contact_preference:view'),
    ('SUPPORT', 'crm:followup:view'),
    ('SUPPORT', 'crm:inquiry:view'),
    ('SUPPORT', 'crm:interaction:view'),
    ('SUPPORT', 'crm:party:view'),
    ('SUPPORT', 'crm:person:read'),
    ('SUPPORT', 'crm:processing_log:view'),
    ('SUPPORT', 'crm:promotion_redemption:view'),
    ('SUPPORT', 'crm:relationship:read'),
    ('SUPPORT', 'crm:segment:view'),
    ('SUPPORT', 'crm:suppression:view'),
    ('SUPPORT', 'crm:suspense:view'),
    ('SUPPORT', 'crm:tag:view'),
    ('SUPPORT', 'crm:vehicle:view'),
    ('SUPPORT', 'inventory:adjustment:view'),
    ('SUPPORT', 'inventory:asn:view'),
    ('SUPPORT', 'inventory:availability:read'),
    ('SUPPORT', 'inventory:cycle_count:view'),
    ('SUPPORT', 'inventory:goods_receipt:view'),
    ('SUPPORT', 'inventory:ledger:view'),
    ('SUPPORT', 'inventory:location:view'),
    ('SUPPORT', 'inventory:on_hand:view'),
    ('SUPPORT', 'inventory:pick_list:view'),
    ('SUPPORT', 'inventory:putaway:view'),
    ('SUPPORT', 'inventory:putaway_rule:view'),
    ('SUPPORT', 'inventory:receiving:view'),
    ('SUPPORT', 'inventory:return:view'),
    ('SUPPORT', 'inventory:scrap:view'),
    ('SUPPORT', 'inventory:shortage:view'),
    ('SUPPORT', 'inventory:supplier_stock_hint:view'),
    ('SUPPORT', 'inventory:transfer:view'),
    ('SUPPORT', 'inventory:valuation:view'),
    ('SUPPORT', 'invoice:analytics:view'),
    ('SUPPORT', 'invoice:invoice:view'),
    ('SUPPORT', 'location:bay:read'),
    ('SUPPORT', 'location:mobile-unit:read'),
    ('SUPPORT', 'location:read'),
    ('SUPPORT', 'location:service-area:read'),
    ('SUPPORT', 'location:travel-buffer-policy:read'),
    ('SUPPORT', 'marketing:campaign:view'),
    ('SUPPORT', 'marketing:stats:view'),
    ('SUPPORT', 'marketing:template:view'),
    ('SUPPORT', 'order:order:view'),
    ('SUPPORT', 'order:price_override:view'),
    ('SUPPORT', 'order:purchase_order:view'),
    ('SUPPORT', 'order:return:view'),
    ('SUPPORT', 'order:session:view'),
    ...
    ('SUPPORT', 'pricing:promotion:view'),
    ('SUPPORT', 'pricing:restrictions:view'),
    ('SUPPORT', 'pricing:rule:view'),
    ('SUPPORT', 'security:audit:view'),
    ('SUPPORT', 'security:permission:view'),
    ('SUPPORT', 'security:role:view'),
    ('SUPPORT', 'security:user:view'),
    ('SUPPORT', 'security:user_account_state:view'),
    ('SUPPORT', 'shop:dashboard:view'),
    ('SUPPORT', 'shop:schedule:view'),
    ('SUPPORT', 'shop:technician:view'),
    ('SUPPORT', 'supplier:audit:read'),
    ('SUPPORT', 'supplier:pricecatalog:read'),
    ('SUPPORT', 'supplier:profile:read'),
    ...
    ('SUPPORT', 'vehicle-fitment:catalog:view'),
    ('SUPPORT', 'vehicle-fitment:hint:view'),
    ('SUPPORT', 'vehicle-inventory:registry:view'),
    ('SUPPORT', 'vehicle-inventory:search:view'),
    ('SUPPORT', 'warranty:claim:view'),
    ('SUPPORT', 'warranty:part-return:view'),
    ('SUPPORT', 'warranty:policy:view'),
    ('SUPPORT', 'warranty:provider:view'),
    ('SUPPORT', 'warranty:registration:view'),
    ('SUPPORT', 'warranty:reimbursement:view'),
    ('SUPPORT', 'workorder:analytics:view'),
    ('SUPPORT', 'workorder:approval_config:view'),
    ('SUPPORT', 'workorder:change_request:view'),
    ('SUPPORT', 'workorder:dashboard:view'),
    ('SUPPORT', 'workorder:estimate:view'),
    ('SUPPORT', 'workorder:estimate_item:view'),
    ('SUPPORT', 'workorder:estimate_snapshot:view'),
    ('SUPPORT', 'workorder:financials:view'),
    ('SUPPORT', 'workorder:invoice:view'),
    ('SUPPORT', 'workorder:labor:view'),
    ('SUPPORT', 'workorder:labor_intelligence:view'),
    ('SUPPORT', 'workorder:note:view'),
    ('SUPPORT', 'workorder:parts:view'),
    ('SUPPORT', 'workorder:wip:view'),
    ('SUPPORT', 'workorder:workorder:view')
