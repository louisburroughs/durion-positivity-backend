...
FROM (VALUES
    ...
    ('ADMIN', 'platform:account:create'),
    ('ADMIN', 'platform:account:read'),
    ('ADMIN', 'platform:account:update'),
    ('ADMIN', 'platform:tenant:create'),
    ('ADMIN', 'platform:tenant:decommission'),
    ('ADMIN', 'platform:tenant:reactivate'),
    ('ADMIN', 'platform:tenant:read'),
    ('ADMIN', 'platform:tenant:suspend'),
    ('ADMIN', 'platform:tenant:update'),
