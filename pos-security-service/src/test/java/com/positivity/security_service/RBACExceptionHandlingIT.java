...
class RBACExceptionHandlingIT extends BaseIntegrationTest {
     ...
     * 
     * **Expected:** 404 NOT_FOUND with ErrorResponse {code="ROLE_NOT_FOUND", correlationId}
     */
    @Test
     ...
     * 
     * **Expected:** 404 NOT_FOUND with ErrorResponse {code="USER_NOT_FOUND", correlationId}
     */
    @Test
