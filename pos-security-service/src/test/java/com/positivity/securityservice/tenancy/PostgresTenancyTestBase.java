...
public abstract class PostgresTenancyTestBase {
    ...
    static void datasource(DynamicPropertyRegistry registry) {
        ...
        // Strict: the module's pg profile keeps the transitional default for the older ITs; the
        // tenancy proofs bind per test and must see nothing otherwise.
        registry.add("pos.tenancy.default-tenant-id", () -> "");
        // The pool no longer carries the transitional session binding either.
