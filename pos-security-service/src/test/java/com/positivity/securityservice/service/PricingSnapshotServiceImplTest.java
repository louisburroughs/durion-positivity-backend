...
class PricingSnapshotServiceImplTest {
    ...
    void createSnapshot_success_returnsDtoWithSteps() throws JsonProcessingException {
        PricingSnapshotRequest request = new PricingSnapshotRequest(
                ...
                List.of(new PricingRuleTraceEntryRequest(
                        "RULE-1", "APPLIED", Map.of("basePrice", 149.99), Map.of("discount", 20.00))));
        ...
        UUID stepId = UUID.fromString("00000000-0000-0000-0000-000000000001");
        ...
        when(pricingRuleTraceEntryRepository.save(any(PricingRuleTraceEntry.class)))
    ...
    void getSnapshot_found_returnsDto() {
        ...
        step.setId(UUID.fromString("00000000-0000-0000-0000-000000000001"));
