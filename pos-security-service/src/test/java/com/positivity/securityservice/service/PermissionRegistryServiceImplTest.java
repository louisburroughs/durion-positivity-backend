...
class PermissionRegistryServiceImplTest {
        ...
        PermissionRegistrationRequest request = new PermissionRegistrationRequest(
                ...
                List.of(
                        new PermissionRegistrationRequest.PermissionDefinition(
                                "pricing:price_book:view", "Updated description"),
                        new PermissionRegistrationRequest.PermissionDefinition(
                                "pricing:price_book:edit", "Allows editing"),
                        new PermissionRegistrationRequest.PermissionDefinition("INVALID_KEY", "Invalid")),
                "1.0");

        when(permissionRepository.findByName("pricing:price_book:view")).thenReturn(Optional.of(existingPermission));
    ...
    void helperMethods_delegateToRepository() {
        ...
        assertThat(permissionRegistryService.permissionExists("pricing:price_book:view"))
                .isTrue();
    ...
    void registerNewPermission_backfillsBitIndex_whenSecondFindReturnsExistingWithNullBitIndex() {
        ...
        PermissionRegistrationRequest request = new PermissionRegistrationRequest(
                "accounting",
                "pos-accounting",
                List.of(new PermissionRegistrationRequest.PermissionDefinition("accounting:je:view", "desc")),
                "1.0");
    ...
    void registerNewPermission_skipsExisting_whenSecondFindReturnsPresentWithNullBitIndexAndUnknownCode() {
        ...
        PermissionRegistrationRequest request = new PermissionRegistrationRequest(
                "pricing",
                "pos-price",
                List.of(new PermissionRegistrationRequest.PermissionDefinition("pricing:unknown:perm", "desc")),
                "1.0");
