...
class AuditTrailContractBehaviorIT extends BaseContractIntegrationTest {
        ...
        void ac6_searchAuditEvents_filtersByEntity() throws Exception {
                ...
                String responseBody = mockMvc.perform(withAuditAdminAuth(get("/v1/audit/events")
                                .param("entityId", "PRODUCT-456")
                ...
                assertThat(events)
                                ...
                                .anySatisfy(event -> {
                                        assertThat(event)
                                                        .containsEntry("entityId", "PRODUCT-456")
