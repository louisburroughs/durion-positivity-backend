...
class PermissionCodeTest {
    ...
    // 498 / 68 since this PR added invoice:analytics:view, accounting:analytics:view, and
    // workorder:analytics:view at bits 495-497. Both numbers move together by design: the
