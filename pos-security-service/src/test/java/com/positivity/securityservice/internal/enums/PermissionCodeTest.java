...
class PermissionCodeTest {
    ...
    private static final int EXPECTED_PERMISSION_COUNT = 362;
    private static final int EXPECTED_CATALOG_VERSION = 20;
    ...
    @Test
    @DisplayName("catalog contains exactly 362 permissions")
