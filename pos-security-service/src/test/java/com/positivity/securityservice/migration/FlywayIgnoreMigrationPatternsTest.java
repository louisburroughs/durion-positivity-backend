...
import com.positivity.securityservice.internal.config.FlywayConfig;
 ...
 *
 * <p>R__seed_security_operational_data.sql was deleted when the alpha fixture packs took over
...
class FlywayIgnoreMigrationPatternsTest {
    ...
    void flywayBean_appliesConfiguredPatterns() {
        ...
        Flyway flyway = new FlywayConfig()
                .mcpFlyway(dataSource, "seed-hash", "", "", "", "jdbc:postgresql://localhost/x", patterns);
