...
/**
 * The tenancy tests' view of the shared {@link CustomerPostgresContainer}: the container's
...
public abstract class PostgresTenancyTestBase {
    ...
    static final String APP_ROLE = CustomerPostgresContainer.APP_ROLE;
    ...
    static DataSource ownerDataSource() {
        return CustomerPostgresContainer.ownerDataSource();
    }
