...
class PartyRelationshipServiceContractBehaviorIT extends BaseContractIntegrationTest {
    ...
    void setUp() {
        ...
        CreatePersonRequest personRequest1 = CreatePersonRequest.builder()
                ...
                .phones(List.of(CreatePersonRequest.PhoneInput.builder()
                        ...
                        .build()))
                .build();
        CreatePersonResponse response1 =
                personService.createPerson(personRequest1, UUID.fromString("00000000-0000-0000-0000-000000000001"));
        ...
        CreatePersonRequest personRequest2 = CreatePersonRequest.builder()
                ...
                .emails(List.of(CreatePersonRequest.EmailInput.builder()
                        ...
                        .build()))
                .build();
        CreatePersonResponse response2 =
                personService.createPerson(personRequest2, UUID.fromString("00000000-0000-0000-0000-000000000001"));
    ...
    void createRelationship_singleRole_succeeds() {
        ...
        CreatePartyRelationshipResponse response = partyRelationshipService.createRelationship(
                testParty.getPartyId(), request, UUID.fromString("00000000-0000-0000-0000-000000000001"));
    ...
    void createRelationship_multipleRoles_succeeds() {
        ...
        assertThat(response.getRoles())
                .containsExactlyInAnyOrder(PartyRelationshipRole.BILLING, PartyRelationshipRole.APPROVER);
    }
    ...
    void createRelationship_newPrimaryBilling_demotesExisting() {
        ...
        CreatePartyRelationshipResponse response1 = partyRelationshipService.createRelationship(
                testParty.getPartyId(), request1, UUID.fromString("00000000-0000-0000-0000-000000000001"));
        ...
        CreatePartyRelationshipResponse response2 = partyRelationshipService.createRelationship(
                testParty.getPartyId(), request2, UUID.fromString("00000000-0000-0000-0000-000000000001"));
        ...
        PartyRelationship oldRelationship = partyRelationshipRepository
                .findById(response1.getRelationshipId())
                .orElseThrow();
    ...
    void getContacts_returnsAllActiveRelationships() {
        ...
        GetCommercialAccountContactsResponse response =
                partyRelationshipService.getContactsForCommercialAccount(testParty.getPartyId(), null, "ACTIVE");

        // Then: both contacts returned
        assertThat(response.getContacts()).hasSize(2);
        assertThat(response.getContacts())
                .anyMatch(c -> c.getIndividualId().equals(testPerson1.getPersonId()) && c.isPrimaryBilling());
        assertThat(response.getContacts())
                .anyMatch(c -> c.getIndividualId().equals(testPerson2.getPersonId()) && !c.isPrimaryBilling());
    }
    ...
    void getContacts_filterByRole_returnsMatchingContacts() {
        ...
        GetCommercialAccountContactsResponse response = partyRelationshipService.getContactsForCommercialAccount(
                testParty.getPartyId(), List.of(PartyRelationshipRole.BILLING), "ACTIVE");
    ...
    void deactivateRelationship_setsEndDate() {
        ...
        PartyRelationship relationship = partyRelationshipRepository
                .findById(created.getRelationshipId())
                .orElseThrow();
