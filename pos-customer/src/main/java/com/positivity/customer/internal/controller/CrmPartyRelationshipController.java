...
public class CrmPartyRelationshipController {
        ...
        public ResponseEntity<CreatePartyRelationshipResponse> createRelationship(
                ...
                log.info("Creating relationship: partyId={}, personId={}, roles={}, user={}",
        ...
        public ResponseEntity<Void> designatePrimaryBillingContact(
                ...
                log.info("Designating primary billing contact: partyId={}, relationshipId={}, user={}",
                                partyId, relationshipId, principal != null ? principal.getName() : ANONYMOUS);
        ...
        public ResponseEntity<Void> deactivateRelationship(
                ...
                log.info("Deactivating relationship: partyId={}, relationshipId={}, user={}",
                                partyId, relationshipId, principal != null ? principal.getName() : ANONYMOUS);
