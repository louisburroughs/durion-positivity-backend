...
public final class CustomerEventTypes {
        ...
        public static List<EventTypeRegistration> all() {
                return List.of(
                                ...
                                EventTypeRegistration.write("CRM_PERSON_CREATE",
                                                "Create a new individual person record").build(),
                                EventTypeRegistration.fastRead("CRM_PERSON_GET",
                                                "Retrieve an individual person by ID").build(),
                                EventTypeRegistration.search("CRM_PERSON_SEARCH",
                                                "Search for persons by name, email, or phone").build(),

                                // CrmPartyRelationshipController - 4 events (Issue #110)
                                EventTypeRegistration.write("CRM_RELATIONSHIP_CREATE",
                                                "Create a relationship between a commercial account and an individual")
                                                .build(),
                                EventTypeRegistration.fastRead("CRM_ACCOUNT_CONTACTS_GET",
                                                "Retrieve contacts associated with a commercial account").build(),
