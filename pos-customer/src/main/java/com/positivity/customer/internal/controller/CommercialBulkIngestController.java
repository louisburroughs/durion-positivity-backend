...
public class CommercialBulkIngestController extends AbstractBulkIngestController<CommercialBulkIngestRecord> {
    ...
    @io.swagger.v3.oas.annotations.Operation(
            ...
            description = """
                        ...
                        effective today.
                        Customer numbers are always generated by the service; supplied numbers cannot be \
                        preserved, and rows are deduplicated on legalName, so re-running a batch reports every \
                        row whose legal name already exists as a COMMERCIAL_INGEST_FAILED duplicate instead of \
                        creating a second account for it (the interactive createCrmCommercialAccount still \
                        applies no uniqueness check).
