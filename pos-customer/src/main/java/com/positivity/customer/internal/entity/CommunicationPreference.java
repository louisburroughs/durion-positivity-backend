...
public class CommunicationPreference {
    ...
    @Schema(description = "Email communication preference", example = "OPT_IN", allowableValues = { "OPT_IN", "OPT_OUT",
            "NOT_APPLICABLE" })
    private String emailPreference;

    @Column(name = "sms_preference", length = 20)
    @Schema(description = "SMS communication preference", example = "OPT_OUT", allowableValues = { "OPT_IN", "OPT_OUT",
            "NOT_APPLICABLE" })
    private String smsPreference;

    @Column(name = "phone_preference", length = 20)
    @Schema(description = "Phone communication preference", example = "OPT_IN", allowableValues = { "OPT_IN", "OPT_OUT",
            "NOT_APPLICABLE" })
