...
public class CrmVehiclesController {
    ...
    public ResponseEntity<VehicleResponse> createVehicles(
            ...
            @Parameter(description = "Vehicle creation request", required = true) @RequestBody
    ...
    @io.swagger.v3.oas.annotations.security.SecurityRequirement(
            name = "bearerAuth",
            scopes = {CrmPermissionRegistry.VEHICLE_EDIT})
    ...
    public ResponseEntity<VehicleResponse> updateVehicles(
            ...
            @Parameter(description = "Vehicle update request", required = true) @RequestBody
                    CreateVehicleForPartyRequest body) {
    ...
    @io.swagger.v3.oas.annotations.security.SecurityRequirement(
            name = "bearerAuth",
            scopes = {CrmPermissionRegistry.VEHICLE_DEACTIVATE})
    ...
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
                        description = "Vehicle transferred successfully",
                        content = @Content(schema = @Schema(implementation = VehicleResponse.class))),
                @ApiResponse(responseCode = "400", description = "Bad request - invalid input", content = @Content),
                @ApiResponse(
                        responseCode = "403",
    ...
    @io.swagger.v3.oas.annotations.security.SecurityRequirement(
            name = "bearerAuth",
            scopes = {CrmPermissionRegistry.VEHICLE_PARTY_ASSOC_EDIT})
    ...
    public ResponseEntity<VehicleResponse> transferVehicles(
            ...
            @Parameter(description = "Transfer request with target customer", required = true) @RequestBody
                    VehicleTransferRequest body) {
