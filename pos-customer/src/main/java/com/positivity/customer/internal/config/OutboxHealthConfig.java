 ...
 * contributor in {@code /actuator/health} plus the {@code customer.outbox.pending} and
 * {@code customer.outbox.oldest.age.seconds} gauges that the domain-events Grafana alerts fire on.
 *
