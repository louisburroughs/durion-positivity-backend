    ...
    public static List<EventTypeRegistration> all() {
        return List.of(
                ...
                EventTypeRegistration
                        .write("CUSTOMER_PARTY_CREATE", "Create a new commercial party/account")
                        .build(),
                EventTypeRegistration
                        .search("CUSTOMER_PARTY_SEARCH",
                ...
                EventTypeRegistration.write(
                                "CUSTOMER_CONTACT_ROLE_UPDATE",
                                "Assign or update role assignments for a contact")
                        .build(),
                EventTypeRegistration.write(
                ...
                EventTypeRegistration.write(
                                "CUSTOMER_VEHICLE_CREATE_LEGACY",
                                "Create vehicle for customer (legacy path)")
                        .build(),
                EventTypeRegistration.write("CUSTOMER_VEHICLE_UPDATE", "Update vehicle information")
                        .build(),
                EventTypeRegistration
                        .write("CUSTOMER_VEHICLE_DELETE",
                                "Delete or deactivate vehicle association")
                        .build(),
                EventTypeRegistration
                        .write("CUSTOMER_VEHICLE_TRANSFER",
                                "Transfer vehicle ownership between customers")
                        .build(),

                // CrmContactsController - 1 event (legacy path)
                EventTypeRegistration
                        .write("CUSTOMER_CONTACT_ROLE_UPDATE_LEGACY",
                                "Update contact roles (legacy path)")
                        .build(),
                ...
                EventTypeRegistration
                        .write("CRM_PERSON_CREATE", "Create a new individual person record")
                        .build(),
                EventTypeRegistration.fastRead("CRM_PERSON_GET", "Retrieve an individual person by ID")
                        .build(),
                EventTypeRegistration
                        .search("CRM_PERSON_SEARCH",
                ...
                EventTypeRegistration.fastRead(
                                ...
                                "Retrieve contacts associated with a commercial account")
                        .build(),
                EventTypeRegistration.write(
                ...
                EventTypeRegistration.fastRead(
                        ...
                        .build(),
                EventTypeRegistration
                        .fastRead("CRM_SNAPSHOT_BILLING_RULES_GET",
                                "Get billing rules for party")
                        .build(),
                ...
                EventTypeRegistration.write(
                        ...
                        .build(),
                EventTypeRegistration
                        .search("PROMOTION_REDEMPTION_LIST", "List redemptions by customer ID")
                        .apiVersion("1")
                        .build(),
