...
shaped like the gate blocks in `durion/domains/general/mcp-server/archive/implementation_checklist.md`.
...
Wave 0.3 of `durion/domains/general/mcp-server/archive/gate-closeout-plan-1212-1219.md`.
...
def load_write_target(path):
    ...
    if "<" in placeholder and ">" in placeholder:
        raise SystemExit(
            ...
            "write target is decision C in durion/domains/general/mcp-server/archive/gate-closeout-plan-1212-1219.md: "
...
def build_markdown(args, personas, suites, baseline, started):
    ...
    out = [
        ...
        "durion/domains/general/mcp-server/archive/implementation_checklist.md -->",
        "",
