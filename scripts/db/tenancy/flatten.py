...
# collide with a row it cannot see. See ../durion/docs/architecture/deployment/TENANCY_SCHEMA.md, "Business-key primary keys".
TENANT_LED_PK = {
...
-- ../durion/docs/architecture/deployment/TENANCY_SCHEMA.md. Global (unscoped) tables: src/main/resources/db/tenancy-global-tables.txt.
--
