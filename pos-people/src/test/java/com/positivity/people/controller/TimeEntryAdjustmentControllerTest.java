...
class TimeEntryAdjustmentControllerTest {
    ...
    void approveAdjustment_notFound_throwsExceptionForHandler() {
        ...
        doThrow(new NotFoundException("Adjustment not found"))
                .when(service)
                .approveAdjustment(eq(adjustmentId), anyString(), any());

        assertThrows(NotFoundException.class, () -> controller.approveAdjustment(adjustmentId, "cid-1"));
    }
    ...
    void approveAdjustment_forbidden_throwsExceptionForHandler() {
        ...
        assertThrows(AccessDeniedException.class, () -> controller.approveAdjustment(adjustmentId, "cid-1"));
    }
}
