...
class EmployeeProfileContractBehaviorIT extends BaseContractIntegrationTest {
    ...
    void cp117001_createEmployeeProfile_returns201() throws Exception {
        String employeeNumber = "EMP-117-001-"
                + UUID.fromString("00000000-0000-0000-0000-000000000001")
                        .toString()
                        .substring(0, 8);
        mockMvc.perform(withAuth(post("/v1/people/employees")
    ...
    void ve117002_strictDuplicate_returns409() throws Exception {
        ...
        mockMvc.perform(withAuth(post("/v1/people/employees")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(employeePayload(
                                employeeNumber, "alex.117.003+" + employeeNumber + "@example.com", "STRICT"))))
                .andExpect(status().isCreated());

        mockMvc.perform(withAuth(post("/v1/people/employees")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(employeePayload(
                                employeeNumber, "alex.117.004+" + employeeNumber + "@example.com", "STRICT"))))
    ...
    void cp117002_balancedDuplicate_returns201WithWarnings() throws Exception {
        ...
        mockMvc.perform(withAuth(post("/v1/people/employees")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(employeePayload(
                                employeeNumber, "alex.117.005+" + employeeNumber + "@example.com", "STRICT"))))
                .andExpect(status().isCreated());

        mockMvc.perform(withAuth(post("/v1/people/employees")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(employeePayload(
                                employeeNumber, "alex.117.006+" + employeeNumber + "@example.com", "BALANCED"))))
                .andExpect(status().isCreated())
    ...
    void cp117004_updateEmployeeProfile_returns200() throws Exception {
        ...
        String response = mockMvc.perform(withAuth(post("/v1/people/employees")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(employeePayload(
                                employeeNumber, "alex.117.007+" + employeeNumber + "@example.com", "STRICT"))))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString();
        ...
        String updatePayload = """
				{
				  ...
				  "contactInfo": {
				                                                ...
				                                                """.formatted(employeeNumber, "alex.117.007+" + employeeNumber + "@example.com");
        ...
        return """
				{
				  ...
				  "contactInfo": {
				    ...
				    "secondaryEmail": "alex.secondary@example.com",
				                                                ...
				                                                """.formatted(employeeNumber, duplicatePolicy, email, numericSuffix, numericSuffix);
    }
}
