...
/**
 * Materialised location-scope ancestor sets on the pos-people {@code ext_location} replica
...
@DataJpaTest(
        properties = {
            "spring.datasource.url=jdbc:h2:mem:pos_people_loc_hier;MODE=PostgreSQL;DB_CLOSE_DELAY=-1;DB_CLOSE_ON_EXIT=FALSE",
...
@DisplayName("pos-people LocationHierarchyService — materialised scope ancestor sets")
