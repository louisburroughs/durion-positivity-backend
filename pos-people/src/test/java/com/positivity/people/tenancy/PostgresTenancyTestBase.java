...
import com.positivity.people.PeoplePostgresContainer;
...
/**
 * Full-context tenancy tests against the shared {@link PeoplePostgresContainer}, laid out
...
public abstract class PostgresTenancyTestBase {
    ...
    static final String APP_ROLE = PeoplePostgresContainer.APP_ROLE;
    ...
    static DataSource ownerDataSource() {
        return PeoplePostgresContainer.ownerDataSource();
    }
