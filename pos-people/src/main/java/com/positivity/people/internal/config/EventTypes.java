        ...
        public static List<EventTypeRegistration> all() {
                return List.of(
                                ...
                                EventTypeRegistration.write(
                                                ...
                                                "Create a person-to-location staffing assignment")
                                                .build(),
                                EventTypeRegistration
                                                .write("PEOPLE_STAFFING_ASSIGNMENT_UPDATE",
                                                                "Update a staffing assignment")
                                                .build(),
                                EventTypeRegistration
                                                .write("PEOPLE_STAFFING_ASSIGNMENT_END", "End a staffing assignment")
                                                .build(),
                                ...
                                EventTypeRegistration
                                                .write("PEOPLE_WORK_SESSION_START", "Start a work session for a person")
                                                .build(),
                                EventTypeRegistration.write("PEOPLE_WORK_SESSION_STOP", "Stop an active work session")
                                                .build(),
                                EventTypeRegistration.write(
                                                "PEOPLE_WORK_SESSION_BREAK_START",
                                                "Start a break within an active work session")
                                                .build(),
                                EventTypeRegistration
                                                .write("PEOPLE_WORK_SESSION_BREAK_STOP",
                                                                "End a break within a work session")
                                                .build(),

                                // TimeEntryAdjustmentController - 2 events
                                EventTypeRegistration.write(
                                                "PEOPLE_TIME_ENTRY_ADJUSTMENT_CREATE",
                                                "Create a time entry adjustment request")
                                                .build(),
                                EventTypeRegistration.approval(
                                                "PEOPLE_TIME_ENTRY_ADJUSTMENT_APPROVE",
                                                "Approve a pending time entry adjustment")
                                                .build(),

                                // TimeEntryApprovalController - 2 events
                                EventTypeRegistration
                                                .approval("PEOPLE_TIME_ENTRY_APPROVE", "Batch approve time entries")
                                                .build(),
                                ...
                                EventTypeRegistration.write(
                                                "PEOPLE_TIME_ENTRY_EXCEPTION_CREATE",
                                                "Create a time entry exception record")
                                                .build(),
                                EventTypeRegistration
                                                .write("PEOPLE_TIME_ENTRY_EXCEPTION_ACKNOWLEDGE",
                                                                "Acknowledge an exception")
                                                .build(),
                                EventTypeRegistration
                                                .write("PEOPLE_TIME_ENTRY_EXCEPTION_RESOLVE",
                                                                "Mark an exception as resolved")
                                                .build(),
                                EventTypeRegistration
                                                .write("PEOPLE_TIME_ENTRY_EXCEPTION_WAIVE",
                                                                "Waive an exception with a reason")
                                                .build(),
                                ...
                                EventTypeRegistration
                                                .fastRead("PEOPLE_ACCESS_ROLES_LIST",
                                                                "List available access roles for people")
                                                .build(),
                                EventTypeRegistration
                                                .fastRead("PEOPLE_ACCESS_ASSIGNMENTS_LIST",
                                                                "List role assignments for a person")
                                                .build(),
                                EventTypeRegistration
                                                .write("PEOPLE_ACCESS_ASSIGNMENT_CREATE",
                                                                "Create role assignment for a person")
                                                .build(),
                                EventTypeRegistration
                                                .write("PEOPLE_ACCESS_ASSIGNMENT_REVOKE",
                                                                "Revoke role assignment for a person")
                                                .build(),
