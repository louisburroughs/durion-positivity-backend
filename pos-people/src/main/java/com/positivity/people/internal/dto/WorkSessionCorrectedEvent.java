...
public record WorkSessionCorrectedEvent(
        ...
        @Schema(
                description = "Identifier of the original session being corrected",
                example = "01960011-0000-7000-8000-000000000001",
                requiredMode = Schema.RequiredMode.REQUIRED)
        UUID originalSessionId,

        @Schema(
                description = "Identifier of the correcting session",
                example = "01960011-0000-7000-8000-000000000004",
                requiredMode = Schema.RequiredMode.REQUIRED)
        UUID correctionId,
        ...
        @Schema(
                description = "Corrected session start timestamp",
                example = "2026-02-16T08:00:00Z",
                requiredMode = Schema.RequiredMode.REQUIRED)
        Instant startTime,

        @Schema(
                description = "Corrected session end timestamp",
        ...
        @Schema(
                description = "Reason the session was corrected",
