...
public class StaffingAssignmentController {
        ...
        @Operation(summary = "Get assignment by ID", description = "Retrieves a single staffing assignment by its unique ID.")
        ...
        @Operation(summary = "Update staffing assignment", description = "Updates an existing staffing assignment, including role, dates, and primary flag.")
        ...
        @Operation(summary = "End (soft-delete) an assignment", description = "Ends an active staffing assignment without physically deleting the record.")
