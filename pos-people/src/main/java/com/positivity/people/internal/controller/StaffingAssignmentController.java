...
public class StaffingAssignmentController {
    ...
    @Operation(
            ...
            description = """
                    ...
                    Preconditions: the person must hold an ACTIVE employee record here, the location must be \
                    active, and no assignment for the same person, location, and role may overlap the effective \
                    dates.
