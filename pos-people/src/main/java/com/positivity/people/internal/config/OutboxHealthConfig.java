 ...
 * contributor in {@code /actuator/health} plus the {@code people.outbox.pending} and
 * {@code people.outbox.oldest.age.seconds} gauges that the domain-events Grafana alerts fire on.
 *
