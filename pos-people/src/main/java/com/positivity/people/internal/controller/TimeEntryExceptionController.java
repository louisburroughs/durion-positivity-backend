...
public class TimeEntryExceptionController {
        ...
        public ResponseEntity<Object> acknowledgeException(
                ...
                exceptionService.actionException(
                                exceptionId, com.positivity.people.internal.enums.ExceptionStatus.ACKNOWLEDGED, null,
                                correlationId);
        ...
        public ResponseEntity<Object> resolveException(
                ...
                exceptionService.actionException(
                                exceptionId, com.positivity.people.internal.enums.ExceptionStatus.RESOLVED, notes,
                                correlationId);
                return ResponseEntity.ok().build();
        }
