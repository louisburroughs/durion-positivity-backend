...
public class TimeEntryExceptionController {
	...
	public ResponseEntity<Object> acknowledgeException(@PathVariable java.util.UUID exceptionId,
		...
		exceptionService.actionException(exceptionId, com.positivity.people.internal.enums.ExceptionStatus.ACKNOWLEDGED,
				null, correlationId);
	...
	public ResponseEntity<Object> resolveException(@PathVariable java.util.UUID exceptionId,
		...
		exceptionService.actionException(exceptionId, com.positivity.people.internal.enums.ExceptionStatus.RESOLVED,
				notes, correlationId);
		return ResponseEntity.ok().build();
	}
	...
	public ResponseEntity<Object> waiveException(@PathVariable java.util.UUID exceptionId,
			...
			@RequestHeader(value = "X-Correlation-Id", required = false) String correlationId) {
		exceptionService.actionException(exceptionId, com.positivity.people.internal.enums.ExceptionStatus.WAIVED,
				request.getWaiveReason(), correlationId);
		return ResponseEntity.ok().build();
	}
