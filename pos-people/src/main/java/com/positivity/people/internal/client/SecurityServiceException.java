...
/**
 * Exception thrown when Security service integration fails.
 * Indicates that a cross-service call to the Security module encountered an error.
 *
 * Scenarios:
 * - Security service is unavailable (circuit breaker open, timeout, connection refused)
 * - User or role not found (404)
 * - Invalid request (400)
 * - Server error (5xx)
 */
