...
public class LocationManifestListener {
    ...
    @Value("${pos.people.kafka.location-commands-topic:location.commands.v1}")
    ...
    @KafkaListener(
            topics = "${pos.people.kafka.location-manifest-topic:location.manifest.v1}",
            groupId = "${pos.people.kafka.location-manifest-consumer-group:pos-people-location-manifests}")
