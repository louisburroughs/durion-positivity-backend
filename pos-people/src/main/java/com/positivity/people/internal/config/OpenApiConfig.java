...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
            .info(new Info().title("POS Human Resources Service API")
            ...
            .tags(Arrays.asList(new Tag().name("People API").description("Operations related to people records"),
                    new Tag().name("People Availability API")
                        .description("Operations for querying people availability"),
                    new Tag().name("People Reports API")
                    ...
                    new Tag().name("Work Sessions API")
