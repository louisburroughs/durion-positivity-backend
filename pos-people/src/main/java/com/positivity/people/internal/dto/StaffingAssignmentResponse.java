...
public class StaffingAssignmentResponse {
    ...
    @Schema(description = "Assignment identifier", example = "33333333-3333-3333-3333-333333333333", requiredMode = Schema.RequiredMode.REQUIRED)
    private UUID assignmentId;

    @Schema(description = "Person identifier", example = "123e4567-e89b-12d3-a456-426614174000", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "Whether this assignment is primary", example = "true", requiredMode = Schema.RequiredMode.REQUIRED)
    private boolean primary;

    @Schema(description = "Assignment lifecycle status", requiredMode = Schema.RequiredMode.REQUIRED)
    private AssignmentStatus status;

    @Schema(description = "Assignment effective start date", example = "2026-02-16", requiredMode = Schema.RequiredMode.REQUIRED)
