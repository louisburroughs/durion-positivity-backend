...
/**
 * Consumer-side reconciliation for the people-contact identity replicas (ADR-0044 §4, issue #875).
 *
...
public class PeopleContactManifestListener {
    ...
    @KafkaListener(
            topics = "${pos.people.kafka.people-contact-manifest-topic:people-contact.manifest.v1}",
            groupId = "${pos.people.kafka.people-contact-manifest-consumer-group:pos-people-people-contact-manifests}")
