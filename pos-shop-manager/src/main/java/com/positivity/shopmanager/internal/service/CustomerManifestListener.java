...
public class CustomerManifestListener {
    ...
    @Value("${pos.shop-manager.kafka.customer-commands-topic:customer.commands.v1}")
    ...
    @KafkaListener(
            topics = "${pos.shop-manager.kafka.customer-manifest-topic:customer.manifest.v1}",
            groupId = "${pos.shop-manager.kafka.customer-manifest-consumer-group:pos-shop-manager-customer-manifests}")
