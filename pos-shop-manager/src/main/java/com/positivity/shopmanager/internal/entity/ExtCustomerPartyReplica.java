 ...
 * facts; this module only builds appointment customer snapshots from it — the surface previously
 * fetched synchronously by {@code CrmCustomerClient}.
 */
@Data
@Builder
@NoArgsConstructor
...
public class ExtCustomerPartyReplica extends TenantScopedEntity {
