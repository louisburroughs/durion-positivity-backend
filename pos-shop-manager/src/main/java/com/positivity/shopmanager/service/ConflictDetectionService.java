...
public interface ConflictDetectionService {
    ...
    boolean isWithinOperatingHours(
            String facilityId, String scheduledStartDateTime, String scheduledEndDateTime, String facilityTimeZoneId);
     ...
     */
    java.util.List<ConflictResponse.Conflict> checkMechanicAvailability(
            String facilityId, String scheduledStartDateTime, String scheduledEndDateTime);
     ...
     */
    java.util.List<ConflictResponse.Conflict> checkBayAvailability(
            String facilityId, String scheduledStartDateTime, String scheduledEndDateTime);
}
