...
class AssignmentServiceTest {
    ...
    @Mock private AssignmentMechanicRepository assignmentMechanicRepository;
    ...
    void ac4_multipleWithNoLead_throwsIllegalArgument() {
        var request = CreateAssignmentRequest.builder()
                ...
                .mechanics(List.of(
                        MechanicAssignmentItem.builder().mechanicPersonId("P1").role(MechanicRole.ASSIST).build(),
                        MechanicAssignmentItem.builder().mechanicPersonId("P2").role(MechanicRole.ASSIST).build()))
                .build();
    ...
    void ac5_overrideFieldRoundTrips() {
        ...
        var request = CreateAssignmentRequest.builder()
                .appointmentId(appointmentId)
                .mechanics(List.of(
                        MechanicAssignmentItem.builder().mechanicPersonId("P-001").role(MechanicRole.LEAD).build()))
                .override(true)
                .overrideReason("manager approved")
                .build();
