...
@SpringBootTest(classes = PosShopManagerApplication.class)
...
class ContractBehaviorIT extends BaseContractIntegrationTest {
        ...
        void testAppointment_TimestampFormatWithTimezone() throws Exception {
                ...
                String scheduledStart = objectMapper.readTree(result.getResponse().getContentAsString())
                                .get("scheduledStartDateTime").asString();
        ...
        void testAppointment_ValidEnumValues() throws Exception {
                ...
                String sourceType = objectMapper.readTree(result.getResponse().getContentAsString()).get("sourceType")
                                .asString();
                String assignmentType = objectMapper.readTree(result.getResponse().getContentAsString())
                                .get("assignmentType")
                                .asString();
        ...
        private String createAppointmentPayload(String sourceId, String sourceType, String facilityId,
                ...
                return String.format(
                                ...
                                sourceId, sourceType, facilityId, scheduledStartDateTime, scheduledEndDateTime,
                                assignmentType);
        }
}
