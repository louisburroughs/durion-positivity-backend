...
import com.positivity.shopmanager.ShopManagerPostgresContainer;
...
/**
 * Full-context tenancy tests against the shared {@link ShopManagerPostgresContainer}, laid out
...
public abstract class PostgresTenancyTestBase {
    ...
    static final String APP_ROLE = ShopManagerPostgresContainer.APP_ROLE;
    ...
    static DataSource ownerDataSource() {
        return ShopManagerPostgresContainer.ownerDataSource();
    }
    ...
    static void datasource(DynamicPropertyRegistry registry) {
        ShopManagerPostgresContainer.registerDataSourceProperties(registry);
    }
}
