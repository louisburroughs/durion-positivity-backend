...
class ScheduleViewContractBehaviorIT extends BaseContractIntegrationTest {
    ...
    private Appointment saveAppointment(
            UUID locationId, String resourceId, String resourceType, Instant startAt, Instant endAt) {
    ...
    void should_return_200_with_only_matching_resourceType_when_filter_applied() throws Exception {
        ...
        mockMvc.perform(withGatewayAuth(get("/v1/schedules/view")
                ...
                .andExpect(jsonPath("$.resources[*].resourceType")
                        .value(org.hamcrest.Matchers.everyItem(org.hamcrest.Matchers.is("BAY"))));
    }
    ...
    void should_return_400_when_locationId_query_param_is_missing() throws Exception {
        mockMvc.perform(withGatewayAuth(get("/v1/schedules/view").param("date", TEST_DATE)))
    ...
    void should_return_400_when_date_query_param_is_missing() throws Exception {
        mockMvc.perform(withGatewayAuth(get("/v1/schedules/view").param("locationId", TEST_LOCATION_ID.toString())))
                .andExpect(status().isBadRequest());
    }
    ...
    void should_return_hasConflict_true_with_BLOCKING_severity_when_appointments_overlap() throws Exception {
        ...
        mockMvc.perform(withGatewayAuth(get("/v1/schedules/view")
                ...
                .andExpect(jsonPath("$.resources[0].events[0].conflictDetails.conflictingEventIds")
                        .isArray())
                .andExpect(jsonPath(
                        "$.resources[0].events[0].conflictDetails.conflictingEventIds",
                        org.hamcrest.Matchers.hasSize(1)))
                .andExpect(jsonPath("$.resources[0].events[0].conflictDetails.conflictingEventIds[0]")
                        .isNotEmpty())
                ...
                .andExpect(jsonPath("$.resources[0].events[1].conflictDetails.conflictingEventIds")
                        .isArray())
                .andExpect(jsonPath(
                        "$.resources[0].events[1].conflictDetails.conflictingEventIds",
                        org.hamcrest.Matchers.hasSize(1)))
                .andExpect(jsonPath("$.resources[0].events[1].conflictDetails.conflictingEventIds[0]")
                        .isNotEmpty());
    }
    ...
    void should_return_hasConflict_false_when_appointments_do_not_overlap() throws Exception {
        ...
        mockMvc.perform(withGatewayAuth(get("/v1/schedules/view")
                ...
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.resources").isArray())
                .andExpect(jsonPath("$.resources[?(@.resourceId == 'BAY-01')].events[*].hasConflict")
    ...
    void should_return_200_with_UNAVAILABLE_overlay_status_when_hr_system_is_down() throws Exception {
        ...
        mockMvc.perform(withGatewayAuth(get("/v1/schedules/view")
                ...
                .andExpect(jsonPath("$.warnings").value(org.hamcrest.Matchers.hasItem("HR_SYSTEM_UNAVAILABLE")));
    }
