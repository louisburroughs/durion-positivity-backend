...
class ConflictOverrideServiceTest {
    ...
    /**
     * AC1 + AC4: When a valid override request is submitted for a known
     * appointment,
     * the appointment is flagged with isConflictOverride=true, an OverrideRecord is
     * persisted with the actor and timestamp, and the response contains the
     * override
    ...
    /**
     * AC3 (empty): An empty override reason is also rejected before any repo is
     * touched.
     */
    @Test
     ...
     * AppointmentNotFoundException without persisting any record.
     */
    @Test
