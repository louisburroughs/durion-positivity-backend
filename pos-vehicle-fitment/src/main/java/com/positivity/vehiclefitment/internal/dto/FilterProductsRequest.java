...
public class FilterProductsRequest {
    ...
    private Map<
                    @NotBlank(message = "attribute key must not be blank") String,
                    @NotBlank(message = "attribute value must not be blank") String>
            vehicleAttributes;
}
