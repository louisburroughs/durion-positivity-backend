 ...
 * {@link com.positivity.order.tenancy.PostgresTenancyTestBase} and the {@code @DataJpaTest}
 * {@link PostgresSliceTestBase} — and one container bootstrap per base class is a copy too many.
 *
 * <p>Requires Docker.
 */
public final class OrderPostgresContainer {
    ...
    private OrderPostgresContainer() {}
