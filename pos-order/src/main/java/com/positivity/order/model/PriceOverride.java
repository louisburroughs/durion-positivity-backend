package com.positivity.order.model;
 ...
 * 
 * <p>Tracks the complete lifecycle from request through approval to application.
 * Implements comprehensive audit trail requirements with immutable state transitions.
 */
@Entity
