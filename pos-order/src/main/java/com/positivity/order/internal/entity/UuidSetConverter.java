 ...
 * of canonical UUID strings (ADR-0061 §2, #1872). Used for the materialised location-scope
 * ancestor sets on {@link ExtLocation}; same contract as pos-people's converter of the same name.
 *
