...
/**
 * Register (drawer) sessions & cash management endpoints (parity stories G1/G2, spec R6.1–R6.6):
 * open a session, record cash movements, run mid-day/close reports, and reconcile the drawer at
 * close.
 */
@RestController
