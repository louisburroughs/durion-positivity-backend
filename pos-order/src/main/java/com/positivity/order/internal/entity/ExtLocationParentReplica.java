 ...
 * facts (ADR-0044 §6), mirroring pos-inventory's, pos-people's and pos-invoice's replicas of the
 ...
 *
 * <p>Feeds the materialised location-scope ancestor sets on {@link ExtLocation} (ADR-0061 §2,
 * #1872): the upward walk follows these edges by type, and the downward walk finds the
 * descendants whose sets a re-parenting invalidates.
 */
@Data
@Builder
@NoArgsConstructor
