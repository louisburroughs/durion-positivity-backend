...
public class PriceOverrideExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleOverrideNotFound(
        ...
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
                ...
                .body(ApiError.of("ORDER_PRICE_OVERRIDE_NOT_FOUND", ex.getMessage(),
    ...
    public ResponseEntity<ApiError> handleInvalidOverride(
        ...
        return ResponseEntity.status(422)
                .header(X_CORRELATION_ID, correlationId)
                .body(ApiError.of("ORDER_PRICE_OVERRIDE_INVALID", ex.getMessage(),
    ...
    public ResponseEntity<ApiError> handleIdempotencyConflict(
        ...
        return ResponseEntity.status(HttpStatus.CONFLICT)
                .header(X_CORRELATION_ID, correlationId)
                .body(ApiError.of("ORDER_PRICE_OVERRIDE_IDEMPOTENCY_CONFLICT", ex.getMessage(),
    ...
    public ResponseEntity<ApiError> handleIllegalArgument(
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .header(X_CORRELATION_ID, correlationId)
                .body(ApiError.of("ORDER_PRICE_OVERRIDE_BAD_REQUEST", ex.getMessage(),
