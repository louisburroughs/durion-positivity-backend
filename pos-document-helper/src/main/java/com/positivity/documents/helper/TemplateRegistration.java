 ...
 *
 * <p>
 * Modules register templates at startup via PUT
 * /v1/documents/templates/{templateId}.
 * Templates are versioned and can be re-registered on service restart to ensure
 * freshness.
 *
 * <p>
 * Mirrors the event registration pattern established in pos-events (ADR-0020).
 *
 * Issue: ADR-0020
 */
@Data
...
public class TemplateRegistration {
    ...
    /**
     * Unique identifier for the template (e.g., "INVOICE_STANDARD",
     * "ESTIMATE_DETAILED").
