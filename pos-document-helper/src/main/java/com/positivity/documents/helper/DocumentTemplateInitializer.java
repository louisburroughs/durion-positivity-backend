...
public abstract class DocumentTemplateInitializer implements ApplicationRunner {
    ...
    protected DocumentTemplateInitializer(
        ...
        RestClient restClient =
                restClientBuilder.baseUrl(documentServiceBaseUrl).build();
    ...
    public void run(ApplicationArguments args) {
        try {
            ...
            log.info(
                    "[{}] Document template initialization complete: {}/{} templates registered",
                    serviceName,
                    registered,
                    templates.size());
            ...
            log.error(
                    "[{}] Document template initialization failed: {}. Service will start but document rendering may not work.",
                    serviceName,
                    e.getMessage(),
                    e);
        }
