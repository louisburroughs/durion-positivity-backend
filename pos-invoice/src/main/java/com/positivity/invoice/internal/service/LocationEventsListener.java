 ...
 * replacing the retired synchronous {@code LocationServiceClient} tax-address lookup.
 *
...
public class LocationEventsListener {
    ...
    @KafkaListener(
            ...
            groupId = "${pos.invoice.kafka.location-events-consumer-group:pos-invoice-location-events}")
    @Transactional
