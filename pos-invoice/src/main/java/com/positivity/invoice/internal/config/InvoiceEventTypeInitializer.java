...
/**
 * Initializes event types for the Invoice module at application startup.
 * CAP:092 - Preferences & Billing Rules
 */
@Component
public class InvoiceEventTypeInitializer implements ApplicationRunner {

    private final RestClient restClient;
    private final EventTypeInitializerSupport initializerSupport;
    private final String apiSecret;

    public InvoiceEventTypeInitializer(
    ...
    public void run(ApplicationArguments args) {
        initializerSupport.registerEventTypes(InvoiceEventTypes.all(), this::registerEventType);
    }
