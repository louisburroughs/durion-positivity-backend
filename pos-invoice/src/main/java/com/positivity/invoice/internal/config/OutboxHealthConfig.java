 ...
 * contributor in {@code /actuator/health} plus the {@code invoice.outbox.pending} and
 * {@code invoice.outbox.oldest.age.seconds} gauges that the domain-events Grafana alerts fire on.
 *
