...
/**
 * ArchUnit tests enforcing architecture rules for pos-invoice module.
 *
 * Enforces:
 ...
 */
@AnalyzeClasses(packages = "com.positivity.invoice", importOptions = ImportOption.DoNotIncludeTests.class)
public class ArchitectureTest {
    ...
    static final ArchRule spring_boot_application_should_be_in_root_package = classes()
            ...
            .should()
            .resideInAPackage("com.positivity.invoice")
            .andShould()
    ...
    static final ArchRule only_service_layer_should_be_public_api = classes()
            .that()
            .resideInAPackage("com.positivity.invoice.service..")
            .should()
            .bePublic()
            .allowEmptyShould(true)
    ...
    // depend on this module's internal implementation. pos-invoice holds no grant, so this package
    // is empty; the rule (with allowEmptyShould) keeps it honest if a grant is ever added.
    // Package patterns are exact-anchored on purpose: "com.positivity.invoice.service.." must NOT
    // match "com.positivity.invoice.internal.service".
    @ArchTest
    static final ArchRule public_service_surface_should_not_depend_on_internal = noClasses()
            ...
            .should()
            .dependOnClassesThat()
            .resideInAPackage("com.positivity.invoice.internal..")
            .allowEmptyShould(true)
    ...
    @ArchTest
    static final ArchRule packages_should_be_free_of_cycles = slices().matching("com.positivity.invoice.internal.(*)..")
            .should()
            .beFreeOfCycles()
            .allowEmptyShould(true)
