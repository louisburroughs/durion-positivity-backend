...
/**
 * The tenancy tests' view of the shared {@link TaxPostgresContainer}: the container's superuser
...
public abstract class PostgresTenancyTestBase {
    ...
    static final String APP_ROLE = TaxPostgresContainer.APP_ROLE;
    ...
    static DataSource ownerDataSource() {
        return TaxPostgresContainer.ownerDataSource();
    }
