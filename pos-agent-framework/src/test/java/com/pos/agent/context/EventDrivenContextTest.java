...
class EventDrivenContextTest {
    ...
    void testAddMessageBroker() {
        // Arrange - setup required for isValid()
    ...
    void testAddErrorHandlingPatterns() {
        ...
        assertTrue(context.getDeadLetterQueues().contains("failed-user-events"));
        assertTrue(context.getDeadLetterQueues().contains("failed-order-events"));
        assertEquals("user-dlq", context.getDeadLetterQueuesMap().get("failed-user-events"));
        assertEquals("order-dlq", context.getDeadLetterQueuesMap().get("failed-order-events"));
    ...
    void testContextValidation() {
        ...
        // Valid with message broker AND event schema
