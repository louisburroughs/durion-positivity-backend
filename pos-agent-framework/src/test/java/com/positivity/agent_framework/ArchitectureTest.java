package com.positivity.agent_framework;
...
/**
 * ArchUnit tests enforcing architecture rules for pos-agent-framework module.
 * 
 * Enforces:
 ...
 */
@AnalyzeClasses(packages = "com.positivity.agent_framework")
public class ArchitectureTest {
    ...
    static final ArchRule spring_boot_application_should_be_in_root_package = classes()
            ...
            .should().resideInAPackage("com.positivity.agent_framework")
    ...
    static final ArchRule only_service_layer_should_be_public_api = classes()
            .that().resideInAPackage("com.positivity.agent_framework.service..")
            .should().bePublic()
            .allowEmptyShould(true)
