...
/**
 * Registers warranty service permissions with pos-security-service at startup.
 */
@Component
public class WarrantyPermissionRegistration extends PermissionRegistrationSupport {

    public WarrantyPermissionRegistration(
