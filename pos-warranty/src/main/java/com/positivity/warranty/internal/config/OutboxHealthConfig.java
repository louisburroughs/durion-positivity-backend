 ...
 * contributor in {@code /actuator/health} plus the {@code warranty.outbox.pending} and
 * {@code warranty.outbox.oldest.age.seconds} gauges that the domain-events Grafana alerts fire on.
 *
