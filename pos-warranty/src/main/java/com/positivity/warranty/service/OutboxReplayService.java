...
/**
 * Re-queues already-published warranty outbox events for re-publication (ADR-0044 §4
 * backfill/drift repair, mirroring pos-invoice). Consumers dedupe by eventId, so replay is
 * idempotent.
 */
