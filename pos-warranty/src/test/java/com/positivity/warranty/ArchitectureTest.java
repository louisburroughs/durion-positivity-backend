...
/**
 * ArchUnit tests enforcing architecture rules for pos-warranty module.
 *
 * Enforces:
 ...
 */
@AnalyzeClasses(packages = "com.positivity.warranty", importOptions = ImportOption.DoNotIncludeTests.class)
public class ArchitectureTest {
    ...
    static final ArchRule spring_boot_application_should_be_in_root_package = classes()
            ...
            .should()
            .resideInAPackage("com.positivity.warranty")
            .andShould()
    ...
    static final ArchRule only_service_layer_should_be_public_api = classes()
            .that()
            .resideInAPackage("com.positivity.warranty.service..")
            .should()
            .bePublic()
            .allowEmptyShould(true)
    ...
    // depend on this module's internal implementation. pos-warranty holds no grant, so this package
    // is empty; the rule (with allowEmptyShould) keeps it honest if a grant is ever added.
    // Package patterns are exact-anchored on purpose: "com.positivity.warranty.service.." must NOT
    // match "com.positivity.warranty.internal.service".
    @ArchTest
    static final ArchRule public_service_surface_should_not_depend_on_internal = noClasses()
            ...
            .should()
            .dependOnClassesThat()
            .resideInAPackage("com.positivity.warranty.internal..")
            .allowEmptyShould(true)
    ...
    static final ArchRule packages_should_be_free_of_cycles = slices().matching(
                    "com.positivity.warranty.internal.(*)..")
            .should()
            .beFreeOfCycles()
            .allowEmptyShould(true)
