 ...
 * {@link com.positivity.warranty.tenancy.PostgresTenancyTestBase} and the {@code @DataJpaTest}
 * {@link PostgresSliceTestBase} — and one container bootstrap per base class is a copy too many.
 *
 * <p>Requires Docker.
 */
public final class WarrantyPostgresContainer {
     ...
     */
    public static final String RESOURCE_LOCK = "pos-warranty-postgres";
    ...
    private WarrantyPostgresContainer() {}
