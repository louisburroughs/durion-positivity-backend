...
/**
 * Security filter that reads authentication headers injected by the API gateway.
 *
 * <h2>How It Works</h2>
 * <ol>
 ...
 *   <li>This filter reads those headers and populates {@link SecurityContextHolder}</li>
...
public class GatewayAuthoritiesFilter extends OncePerRequestFilter {
     ...
     *
     * @param authoritiesHeader comma-separated authorities (e.g., "ROLE_ADMIN,crm:party:view")
