...
public class GatewaySecurityConfig {
    private static final GrantedAuthority ACTUATOR_METRICS_ROLE = new SimpleGrantedAuthority("ROLE_ACTUATOR_METRICS");
    ...
    public SecurityFilterChain gatewaySecurityFilterChain(
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/v1/permissions/register")
                        .permitAll()
        ...
        return new AuthenticationProvider() {
            ...
            public Authentication authenticate(Authentication authentication) {
                ...
                return UsernamePasswordAuthenticationToken.authenticated(
                        username, null, List.of(ACTUATOR_METRICS_ROLE));
            }
