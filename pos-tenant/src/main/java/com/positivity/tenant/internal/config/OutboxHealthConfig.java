 ...
 * contributor in {@code /actuator/health} plus the {@code tenant.outbox.pending} and
 * {@code tenant.outbox.oldest.age.seconds} gauges that the domain-events Grafana alerts fire on.
 *
