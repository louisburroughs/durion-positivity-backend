...
/**
 * ArchUnit tests enforcing architecture rules for pos-tenant module.
 *
 * Enforces:
 ...
 */
@AnalyzeClasses(packages = "com.positivity.tenant", importOptions = ImportOption.DoNotIncludeTests.class)
public class ArchitectureTest {
    ...
    static final ArchRule spring_boot_application_should_be_in_root_package = classes()
            ...
            .should()
            .resideInAPackage("com.positivity.tenant")
            .andShould()
    ...
    static final ArchRule only_service_layer_should_be_public_api = classes()
            .that()
            .resideInAPackage("com.positivity.tenant.service..")
            .should()
            .bePublic()
            .allowEmptyShould(true)
    ...
    // Package patterns are exact-anchored on purpose: "com.positivity.tenant.service.." must NOT
    // match "com.positivity.tenant.internal.service".
    @ArchTest
    static final ArchRule public_service_surface_should_not_depend_on_internal = noClasses()
            ...
            .should()
            .dependOnClassesThat()
            .resideInAPackage("com.positivity.tenant.internal..")
            .allowEmptyShould(true)
    ...
    static final ArchRule internal_service_implementations_should_implement_service_interfaces = classes()
            ...
            .implement(DescribedPredicate.describe(
                    "a service interface in com.positivity.tenant.internal..",
                    javaClass -> javaClass.getPackageName().startsWith("com.positivity.tenant.internal")))
            .allowEmptyShould(true)
    ...
    @ArchTest
    static final ArchRule packages_should_be_free_of_cycles = slices().matching("com.positivity.tenant.internal.(*)..")
            .should()
            .beFreeOfCycles()
            .allowEmptyShould(true)
