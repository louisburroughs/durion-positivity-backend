 ...
 *
 * <p>Ranks and filters tool execution results by relevance to the user query before presenting
 * to the LLM. Reduces noise from tool outputs by scoring each result's relevance.
 *
 * <p>Use case:
 * <ul>
...
public class ToolResultRanker {
     ...
     *
     * <p>Tier 3: LLM-based result re-ranking for quality filtering.
     *
     ...
     *
     * <p>Asks LLM: "Rate this result's relevance to the query on a scale 0-1".
     *
