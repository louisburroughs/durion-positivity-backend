...
/**
 * Registers MCP event types with the event-receiver service on startup.
 */
@Component
public class McpEventTypeInitializer implements ApplicationRunner {

    private static final Logger log = LoggerFactory.getLogger(McpEventTypeInitializer.class);
    private static final String SERVICE_NAME = "pos-mcp-server";

    private final RestClient restClient;
    private final EventTypeInitializerSupport initializerSupport;
    private final String apiSecret;

    public McpEventTypeInitializer(
    ...
    public void run(ApplicationArguments args) {
        initializerSupport.registerEventTypes(McpEventTypes.all(), this::registerViaHttp);
    }
