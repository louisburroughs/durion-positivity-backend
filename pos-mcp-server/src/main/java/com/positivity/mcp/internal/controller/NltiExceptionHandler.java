...
class NltiExceptionHandler {
        ...
        ResponseEntity<ApiError> handleRateLimit(
                ...
                return ResponseEntity.status(HttpStatus.TOO_MANY_REQUESTS)
                                ...
                                .body(ApiError.of("RATE_LIMIT_EXCEEDED", ex.getMessage(),
                                                HttpStatus.TOO_MANY_REQUESTS.value(), Instant.now(clock).toString(),
                                                correlationId.toString()));
        }
        ...
        ResponseEntity<ApiError> handleUnsupported(
                ...
                return ResponseEntity.status(HttpStatus.NOT_IMPLEMENTED)
                                ...
                                .body(ApiError.of("NOT_IMPLEMENTED", ex.getMessage(),
                                                HttpStatus.NOT_IMPLEMENTED.value(), Instant.now(clock).toString(),
                                                correlationId.toString()));
        }
        ...
        ResponseEntity<ApiError> handleAuthentication(
                ...
                return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
                                ...
                                .body(ApiError.of("UNAUTHORIZED", "Authentication is required",
                                                HttpStatus.UNAUTHORIZED.value(), Instant.now(clock).toString(),
                                                correlationId.toString()));
        }
        ...
        ResponseEntity<ApiError> handleUnexpected(
                        ...
                        HttpServletRequest request) {
                UUID correlationId = NltiCorrelationIdSupport.resolveFromRequest(request);
                logger.error("Unhandled controller exception with correlationId={}", correlationId, ex);
                return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                                .header(NltiCorrelationIdSupport.CORRELATION_ID_HEADER, correlationId.toString())
                                .body(ApiError.of("INTERNAL_SERVER_ERROR", "An unexpected error occurred",
                                                HttpStatus.INTERNAL_SERVER_ERROR.value(), Instant.now(clock).toString(),
                                                correlationId.toString()));
        }
}
