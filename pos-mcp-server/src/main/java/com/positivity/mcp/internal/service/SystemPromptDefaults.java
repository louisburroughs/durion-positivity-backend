...
public final class SystemPromptDefaults {
    ...
    static final String GLOSSARY_LAYER_TEXT = """
            ...
            - `defined: false` — the glossary has no entry for that phrase. That is NOT by itself a reason to ask. Read the question again first: if it already names the measure — "top technicians BY LABOR REVENUE", "best customers BY REVENUE", "largest vendors BY SPEND" — use the measure the question named and ANSWER, saying which you used.
