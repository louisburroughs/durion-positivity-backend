 ...
 *
 * <p>
 * Wraps a ContentRetriever and filters results by RBAC metadata. Ensures that
 * retrieved
 * documents respect the user's assigned roles, preventing leakage of
 ...
 * <li>User with role ROLE_INVENTORY_MANAGER should only retrieve
 * inventory-related RAG content
