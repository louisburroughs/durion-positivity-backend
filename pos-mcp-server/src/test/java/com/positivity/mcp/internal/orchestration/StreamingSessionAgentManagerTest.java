...
class StreamingSessionAgentManagerTest {
  ...
  void setUp() {
    ...
    exaWebSearchTool = new ExaWebSearchTool(
        RestClient.builder(), "https://api.exa.ai", "", "auto", 5);
    manager = new StreamingSessionAgentManager(
        streamingChatModel, embeddingModel, embeddingStore,
        toolRegistry, exaWebSearchTool,
        null,
        30, 500, 50, 100);
  }
