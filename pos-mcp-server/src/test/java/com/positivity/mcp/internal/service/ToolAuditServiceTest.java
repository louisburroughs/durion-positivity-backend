...
class ToolAuditServiceTest {
    ...
    void logToolSelection_callsRepository_withCorrectFields() {
        ...
        verify(auditRepository, times(1))
                .logInvocation(argThat(log -> TOOL_ID.equals(log.toolId())
    ...
    void logToolSelection_swallowsException() {
        doThrow(new RuntimeException("db error"))
                ...
                .logInvocation(org.mockito.ArgumentMatchers.any(ToolInvocationLog.class));
    ...
    void logToolExecution_swallowsException() {
        ...
        assertThatNoException()
                .isThrownBy(() -> service.logToolExecution(TOOL_ID, "user-1", false, true, 200, "TIMEOUT"));
    }
}
