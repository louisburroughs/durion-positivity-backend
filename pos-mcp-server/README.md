...
(`serverBuild`, from `MCP_BUILD_ID`, the image tag on alpha; #1806), and how the reply was produced
(`answerSource`: `CONTENT`, `RE_RENDERED`, `LADDER`, or the raw non-content source; #1816) — persisted with a configurable
