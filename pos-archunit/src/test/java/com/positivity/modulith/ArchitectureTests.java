...
class ArchitectureTests {
    ...
    void internalPackagesShouldNotBeAccessedFromOtherModules() {
        ArchRule rule = noClasses()
            ...
            .because("internal packages should not be accessed from other modules - only service layer should be exposed");
    ...
    void onlyServicePackagesShouldBePublic() {
        ArchRule rule = classes()
            ...
            .because("internal classes should not be public unless they are configuration or DTOs used by services");

        // This rule is informational - allows some flexibility for internal public classes
