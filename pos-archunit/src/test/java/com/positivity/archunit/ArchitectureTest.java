...
/**
 * ArchUnit tests enforcing architecture rules for pos-archunit module.
 * 
 * Enforces:
 ...
 */
@AnalyzeClasses(packages = "com.positivity.archunit", importOptions = ImportOption.DoNotIncludeTests.class)
public class ArchitectureTest {
    ...
    static final ArchRule spring_boot_application_should_be_in_root_package = classes()
            ...
            .should().resideInAPackage("com.positivity.archunit")
    ...
    static final ArchRule only_service_layer_should_be_public_api = classes()
            .that().resideInAPackage("com.positivity.archunit.service..")
            .should().bePublic()
            .allowEmptyShould(true)
    ...
    static final ArchRule packages_should_be_free_of_cycles = slices()
            .matching("com.positivity.archunit.internal.(*)..")
