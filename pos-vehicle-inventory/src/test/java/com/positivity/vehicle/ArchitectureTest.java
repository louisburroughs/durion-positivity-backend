...
public class ArchitectureTest {
    ...
    static final ArchRule spring_boot_application_should_be_in_root_package = classes()
            ...
            .should()
            .resideInAPackage("com.positivity.vehicle")
            .andShould()
    ...
    static final ArchRule only_service_layer_should_be_public_api = classes()
            .that()
            .resideInAPackage("com.positivity.vehicle.service..")
            .should()
            .bePublic()
            .allowEmptyShould(true)
    ...
    // depend on this module's internal implementation. pos-vehicle-inventory holds no grant, so this package
    // is empty; the rule (with allowEmptyShould) keeps it honest if a grant is ever added.
    // Package patterns are exact-anchored on purpose: "com.positivity.vehicle.service.." must NOT
    // match "com.positivity.vehicle.internal.service".
    @ArchTest
    static final ArchRule public_service_surface_should_not_depend_on_internal = noClasses()
            ...
            .should()
            .dependOnClassesThat()
            .resideInAPackage("com.positivity.vehicle.internal..")
            .allowEmptyShould(true)
    ...
    @ArchTest
    static final ArchRule packages_should_be_free_of_cycles = slices().matching("com.positivity.vehicle.internal.(*)..")
            .should()
            .beFreeOfCycles()
            .allowEmptyShould(true)
            ...
            .should(new ArchCondition<>("depend on " + UUID_V7_GENERATOR_FQN) {
                ...
                public void check(JavaClass item, ConditionEvents events) {
                    ...
                    events.add(new SimpleConditionEvent(
                            item,
                            dependsOnUuidv7,
                            item.getFullName() + " does not depend on " + UUID_V7_GENERATOR_FQN));
                }
            })
            .allowEmptyShould(true)
