...
import com.positivity.vehicle.VehicleInventoryPostgresContainer;
...
/**
 * Full-context tenancy tests against the shared {@link VehicleInventoryPostgresContainer}, laid out
 * the way Compose and the alpha host are (ADR-0062 §3, layer 2): the container's superuser owns the
...
public abstract class PostgresTenancyTestBase {
    ...
    static final String APP_ROLE = VehicleInventoryPostgresContainer.APP_ROLE;
    ...
    static DataSource ownerDataSource() {
        return VehicleInventoryPostgresContainer.ownerDataSource();
    }
    ...
    static void datasource(DynamicPropertyRegistry registry) {
        VehicleInventoryPostgresContainer.registerDataSourceProperties(registry);
    }
}
