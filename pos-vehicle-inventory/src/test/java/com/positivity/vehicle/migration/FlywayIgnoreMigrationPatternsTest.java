package com.positivity.vehicle.migration;

import static org.assertj.core.api.Assertions.assertThat;
import static org.mockito.Mockito.mock;

import com.positivity.vehicle.internal.config.FlywayConfig;
 ...
 *
 * <p>R__seed_vehicle_inventory_operational_data.sql was deleted when the alpha fixture packs took over
...
class FlywayIgnoreMigrationPatternsTest {
    ...
    void flywayBean_appliesConfiguredPatterns() {
        ...
        Flyway flyway = new FlywayConfig()
                .mcpFlyway(dataSource, "", "", "", "jdbc:postgresql://localhost/x", LOCATIONS, patterns);
