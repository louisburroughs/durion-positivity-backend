...
/**
 * Unit tests for {@link VehicleCommandListener} (ADR-0044 §4, #843).
 */
class VehicleCommandListenerTest {
    ...
    private VehicleCommandListener listener;

    @BeforeEach
    void setUp() {
        listener = new VehicleCommandListener(TEST_CLOCK, new ObjectMapper(), replayService);
    ...
    private String replayCommand(String since, String until) {
        return """
                {"commandType":"vehicle.outbox.replay-requested",
