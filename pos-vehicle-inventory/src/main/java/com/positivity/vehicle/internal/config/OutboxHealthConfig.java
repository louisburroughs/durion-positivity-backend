 ...
 * contributor in {@code /actuator/health} plus the {@code vehicle.outbox.pending} and
 * {@code vehicle.outbox.oldest.age.seconds} gauges that the domain-events Grafana alerts fire on.
 *
