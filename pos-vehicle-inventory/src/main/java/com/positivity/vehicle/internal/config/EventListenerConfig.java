 ...
 * is fully ready.
 *
 * <p>The legacy {@code vehicle.updates} / {@code workorder.completed} listeners were retired with
 * ADR-0044 (#843): nothing ever produced those topics, and cross-module facts now arrive on the
 * versioned {@code {domain}.events.v1} topics. This module's inbound surface is
 * {@code vehicle.commands.v1} ({@link VehicleCommandListener}).
 */
@Slf4j
@Configuration
