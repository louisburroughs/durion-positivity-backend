 ...
 */
@Component
public class VehicleEventTypeInitializer implements ApplicationRunner {

    private static final Logger log = LoggerFactory.getLogger(VehicleEventTypeInitializer.class);
    ...
    public VehicleEventTypeInitializer(
