-- ADR-0044 §4: transactional outbox for domain events (vehicle.events.v1, issue #843).
...
-- The legacy vehicle.updates ingestion pipeline is retired with ADR-0044 (#843): nothing ever
-- produced that topic, and its idempotency log goes with it.
