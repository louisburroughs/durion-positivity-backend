...
public class EventReceiverEventTypeInitializer implements ApplicationRunner {
    ...
    public EventReceiverEventTypeInitializer(EventDao eventDao) {
    ...
    public void run(ApplicationArguments args) {
        log.info("Registering {} event-receiver event types (direct DAO access)", EventReceiverEventTypes.all().size());
