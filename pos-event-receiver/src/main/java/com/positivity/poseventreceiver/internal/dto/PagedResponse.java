...
/**
 * Generic paginated list response wrapper, module-local to pos-event-receiver (copied from
 * pos-accounting's {@code internal.dto.PagedResponse} shape per convention — cross-module
 * DTO imports are not permitted).
 */
@Data
@Builder
@NoArgsConstructor
