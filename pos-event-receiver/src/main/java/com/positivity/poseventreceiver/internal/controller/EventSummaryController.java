...
public class EventSummaryController {
        ...
        @Operation(summary = "Get event summary for the last hour", description = "Returns event counts grouped by event type for the last 60 minutes", tags = {
                        "Event Summary" })
        ...
        @Operation(summary = "Get event summary for the last day", description = "Returns event counts grouped by event type for the last 24 hours", tags = {
                        "Event Summary" })
        @ApiResponse(responseCode = "200", description = "Summary returned successfully", content = @Content(schema = @Schema(implementation = EventSummaryResponse.class)))
        ...
        @Operation(summary = "Get event summary for the last week", description = "Returns event counts grouped by event type for the last 7 days", tags = {
                        "Event Summary" })
        @ApiResponse(responseCode = "200", description = "Summary returned successfully", content = @Content(schema = @Schema(implementation = EventSummaryResponse.class)))
