...
| pos-location `R__seed_location_2_operational_data.sql` | 2 | Seed pipeline; **gap:** no location bulk-ingest/loader strategy yet — use gateway API fallback or add a strategy |
