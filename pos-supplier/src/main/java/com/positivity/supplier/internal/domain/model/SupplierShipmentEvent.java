...
/**
 * One shipment tracking event for a vendor order (LEX shipment tracking v1). Feeds the
 * append-only {@code supplier.shipment.event} fact on the purchase-order timeline in
 * pos-order (ADR-0049 §3).
 *
 * <p>Pragmatic/minimal for the CAP-317 foundation slice; grows with the shipment capability.
 *
 ...
 */
public record SupplierShipmentEvent(
