-- ADR-0062 section 3 (plan WS3 wave 7): supplier_event_outbox is a global table whose rows carry the
...
ALTER TABLE supplier_event_outbox ADD COLUMN tenant_id uuid;

UPDATE supplier_event_outbox SET tenant_id = '01900000-0000-7000-8000-000000000001' WHERE tenant_id IS NULL;

ALTER TABLE supplier_event_outbox ALTER COLUMN tenant_id SET DEFAULT public.app_current_tenant();
ALTER TABLE supplier_event_outbox ALTER COLUMN tenant_id SET NOT NULL;

COMMENT ON COLUMN supplier_event_outbox.tenant_id IS
