 ...
 * contributor in {@code /actuator/health} plus the {@code marketing.outbox.pending} and
 * {@code marketing.outbox.oldest.age.seconds} gauges that the domain-events Grafana alerts fire on.
 *
