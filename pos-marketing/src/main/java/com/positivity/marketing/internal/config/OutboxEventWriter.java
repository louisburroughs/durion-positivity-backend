...
/**
 * Transactional-outbox writer for marketing domain events (ADR-0044 §4, PRD §9.3).
 *
...
public class OutboxEventWriter {
    ...
    /**
     * Queue a pre-serialized message — a {@code {commandType, eventId, payload}} command aimed at
     * another domain's commands topic — in the caller's transaction. Same outbox semantics as
