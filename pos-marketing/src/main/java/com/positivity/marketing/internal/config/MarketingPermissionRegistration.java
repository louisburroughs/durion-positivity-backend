...
/**
 * Registers marketing service permissions with pos-security-service at startup.
 */
@Component
public class MarketingPermissionRegistration extends PermissionRegistrationSupport {

    public MarketingPermissionRegistration(
