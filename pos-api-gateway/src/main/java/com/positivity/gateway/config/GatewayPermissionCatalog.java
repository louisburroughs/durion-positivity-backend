...
public final class GatewayPermissionCatalog {
    ...
    protected static final String[] AUTHORITY_BY_BIT = {
        ...
        "PERM_people:employee:activation",
        ...
        // ── New batch (bits 448–449) ────────────────────────────────────────
        "PERM_supplier:pricecatalog:read", // 448
        "PERM_supplier:pricecatalog:import", // 449

        // ── New batch (bits 450–450) ──────────────────────────────────────────
        "PERM_inventory:supplier_stock_hint:view", // 450
        ...
        // ── New batch (bits 488–489) ──────────────────────────────────────────
        "PERM_people:timePeriod:create", // 488
        "PERM_people:timePeriod:transition", // 489

        // ── New batch (bits 490–490) ──────────────────────────────────────────
        "PERM_tax:rates:view", // 490

        // ── New batch (bits 491–492) ──────────────────────────────────────────
        "PERM_inventory:putaway_rule:manage", // 491
        "PERM_inventory:putaway_rule:view", // 492

        // ── New batch (bits 493–493) ──────────────────────────────────────────
        "PERM_people:timeEntry:view", // 493

        // ── New batch (bits 494–494) ──────────────────────────────────────────
        "PERM_invoice:invoice:view", // 494

        // ── New batch (bits 495–495) ──────────────────────────────────────────
        "PERM_invoice:analytics:view", // 495

        // ── New batch (bits 496–497) ──────────────────────────────────────────
        "PERM_accounting:analytics:view", // 496
        "PERM_workorder:analytics:view", // 497
        ...
        // ── New batch (bits 502–503) ──────────────────────────────────────────
        "PERM_supplier:stockavailability:read", // 502
        "PERM_supplier:stocksnapshot:read", // 503

        // ── New batch (bits 504–505) ──────────────────────────────────────────
        "PERM_catalog:labor_standard:import", // 504
        "PERM_catalog:labor_time:resolve", // 505

        // ── New batch (bits 506–506) ──────────────────────────────────────────
        "PERM_shop:dashboard:view", // 506

        // ── New batch (bits 507–507) ──────────────────────────────────────────
        "PERM_mcp:eval_trace:view", // 507

        // ── New batch (bits 508–508) ──────────────────────────────────────────
        "PERM_catalog:tread_design:resolve", // 508

        // ── New batch (bits 509–509) ──────────────────────────────────────────
        "PERM_accounting:gl:reconcile", // 509

        // ── New batch (bits 510–512) ──────────────────────────────────────────
        "PERM_pricing:labor_rate:manage", // 510
        "PERM_pricing:labor_rate:view", // 511
        "PERM_pricing:labor_rate:quote", // 512

        // ── New batch (bits 513–514) ──────────────────────────────────────────
        "PERM_catalog:service_package:manage", // 513
        "PERM_catalog:service_package:view", // 514

        // ── New batch (bits 515–515) ──────────────────────────────────────────
        "PERM_workorder:labor_intelligence:view", // 515

        // ── New batch (bits 516–516) ──────────────────────────────────────────
        "PERM_catalog:service:ingest", // 516

        // ── New batch (bits 517–517) ──────────────────────────────────────────
        "PERM_people:self:view", // 517

        // ── New batch (bits 518–518) ──────────────────────────────────────────
        "PERM_crm:fact:replay", // 518

        // ── New batch (bits 519–519) ──────────────────────────────────────────
        "PERM_people:employee_pii:view", // 519

        // ── New batch (bits 520–528) ──────────────────────────────────────────
        "PERM_platform:account:create", // 520
        "PERM_platform:account:read", // 521
        "PERM_platform:account:update", // 522
        "PERM_platform:tenant:create", // 523
        "PERM_platform:tenant:decommission", // 524
        "PERM_platform:tenant:reactivate", // 525
        "PERM_platform:tenant:read", // 526
        "PERM_platform:tenant:suspend", // 527
        "PERM_platform:tenant:update", // 528

        // ── New batch (bits 529–529) ──────────────────────────────────────────
        "PERM_platform:tenant:provision", // 529

        // ── New batch (bits 530–530) ──────────────────────────────────────────
        "PERM_platform:tenant:impersonate", // 530

        // ── New batch (bits 531–531) ──────────────────────────────────────────
        "PERM_shop:conflict:override", // 531

        // ── New batch (bits 532–532) ──────────────────────────────────────────
        "PERM_catalog:service_requirement:manage", // 532

        // ── New batch (bits 533–533) ──────────────────────────────────────────
        "PERM_workorder:position:assign", // 533
