...
public class GatewayAuthProperties {
     ...
     * {@code X-Perm-Bits}, {@code X-Perm-Ver}, {@code X-Roles}, the {@code X-Loc-*} location
     * scope headers, and the {@code X-Tenant-Id} / {@code X-Tenant-Slug} tenancy headers
     * (ADR-0062 §3) are stripped before forwarding to downstream services.
     */
