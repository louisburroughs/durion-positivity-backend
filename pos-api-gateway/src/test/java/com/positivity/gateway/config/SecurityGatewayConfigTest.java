...
class SecurityGatewayConfigTest {
         ...
         */
        private static String buildCanonicalToken(String sub, String uid, String personId, String permBits,
                        int permVer) {
        ...
        void canonicalToken_withRoles_forwardsRolesHeader() {
                ...
                String token = buildCanonicalTokenWithRoles(
                                "admin.alpha", "u1", null, permBits, GatewayPermissionCatalog.CATALOG_VERSION,
                                "ROLE_ADMIN");
        ...
        void authorityByBitCoversNewEntries() {
                ...
                assertThat(GatewayPermissionCatalog.authorityForBit(278))
                                .isEqualTo("PERM_timekeeping:overlap_override");
                ...
                assertThat(GatewayPermissionCatalog.authorityForBit(285))
        ...
        class GatewayPermissionCatalogTests {
                ...
                void authorityForBit_236_isPeoplePersonDelete() {
                        assertThat(GatewayPermissionCatalog.authorityForBit(236))
                                        .isEqualTo("PERM_people:person:delete");
                }
        ...
        class Auth007GatewayAlignmentTests {
                ...
                void canonicalToken_withNoAuthoritiesClaim_usesPermBitsPath_notLegacyFallback() {
                        ...
                        var exchange = MockServerWebExchange
                                        .from(MockServerHttpRequest.get("/accounting/v1/journal-entries")
                                                        .header(HttpHeaders.AUTHORIZATION, "Bearer " + token)
                                                        .build());
