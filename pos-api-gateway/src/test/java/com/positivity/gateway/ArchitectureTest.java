...
/**
 * ArchUnit tests enforcing architecture rules for pos-api-gateway module.
 *
 * Enforces:
...
public class ArchitectureTest {
    ...
    static final ArchRule spring_boot_application_should_be_in_root_package = classes()
            ...
            .should()
            .resideInAPackage("com.positivity.gateway")
            .andShould()
    ...
    static final ArchRule only_service_layer_should_be_public_api = classes()
            .that()
            .resideInAPackage("com.positivity.gateway.service..")
            .should()
            .bePublic()
            .allowEmptyShould(true)
    ...
    @ArchTest
    static final ArchRule packages_should_be_free_of_cycles = slices().matching("com.positivity.gateway.internal.(*)..")
            .should()
            .beFreeOfCycles()
            .allowEmptyShould(true)
    ...
    static final ArchRule security_gateway_config_should_not_use_webclient_for_auth = noClasses()
            .that()
            .haveSimpleName("SecurityGatewayConfig")
            .should()
            .dependOnClassesThat()
    ...
    static final ArchRule gateway_permission_catalog_should_not_use_spring = noClasses()
            .that()
            .haveSimpleName("GatewayPermissionCatalog")
            .should()
            .dependOnClassesThat()
