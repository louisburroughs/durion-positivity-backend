package com.positivity.documents.internal.security;
 ...
 */
public final class DocumentsPermissions {
    /** Render document content into supported output formats. */
    public static final String RENDER = "documents:render";

    private DocumentsPermissions() {
