...
public record RestrictionEvaluationItem(
        ...
        @Schema(description = "Location scope tag for the evaluation", example = "RETAIL_STORE", requiredMode = REQUIRED)
                @NotNull LocationTag locationTag,
        @Schema(description = "Service channel scope tag for the evaluation", example = "POS_SALE", requiredMode = REQUIRED)
                @NotNull ServiceTag serviceTag,
        @Schema(description = "Transaction lifecycle context for the evaluation", example = "CHECKOUT", requiredMode = REQUIRED)
