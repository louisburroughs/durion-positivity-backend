    ...
    public static List<EventTypeRegistration> all() {
        return List.of(
                ...
                EventTypeRegistration.search(
                                ...
                                "Evaluate whether a price is within allowed restrictions")
                        .build(),
                EventTypeRegistration.write(
                ...
                EventTypeRegistration
                        .write("PRICE_RESTRICTION_RULE_CREATE", "Create a restriction rule")
                        .apiVersion("1")
                        .build(),
                EventTypeRegistration
                        .write("PRICE_RESTRICTION_RULE_DEACTIVATE",
                ...
                EventTypeRegistration
                        ...
                        .build(),
                EventTypeRegistration
                        .search("PROMOTION_RULE_EVALUATE", "Evaluate eligibility for promotion")
                        .apiVersion("1")
                        .build());
    }
}
