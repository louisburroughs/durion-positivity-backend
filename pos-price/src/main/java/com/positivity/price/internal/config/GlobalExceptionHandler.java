...
public class GlobalExceptionHandler {
        ...
        public ResponseEntity<ApiError> handleValidationError(
                ...
                log.debug("Returning {} for code {} correlationId={}", HttpStatus.BAD_REQUEST.value(),
                                "VALIDATION_ERROR", correlationId);
        ...
        private ApiError.FieldError toFieldError(FieldError fieldError) {
                return new ApiError.FieldError(
                                fieldError.getField(),
                                fieldError.getDefaultMessage() == null ? "Invalid value"
        ...
        private ResponseEntity<ApiError> buildErrorResponse(
                ...
                ApiError body = fieldErrors != null
                                ? ApiError.withFieldErrors(code, message, status.value(),
                                                Instant.now(clock).toString(), correlationId, fieldErrors)
                                : ApiError.of(code, message, status.value(),
