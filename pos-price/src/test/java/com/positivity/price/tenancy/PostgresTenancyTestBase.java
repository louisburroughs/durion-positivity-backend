...
import com.positivity.price.PricePostgresContainer;
...
/**
 * The tenancy tests' view of the shared {@link PricePostgresContainer}: the container's superuser
...
public abstract class PostgresTenancyTestBase {
    ...
    static final String APP_ROLE = PricePostgresContainer.APP_ROLE;
    ...
    static DataSource ownerDataSource() {
        return PricePostgresContainer.ownerDataSource();
    }
