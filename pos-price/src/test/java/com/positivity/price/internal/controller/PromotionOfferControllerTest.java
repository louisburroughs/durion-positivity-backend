...
class PromotionOfferControllerTest extends BaseContractIntegrationTest {
    ...
    void givenExistingId_whenGetOfferById_thenReturns200WithPromoCode() throws Exception {
        ...
        String offerId = com.fasterxml.jackson.databind.json.JsonMapper.builder()
                .build()
    ...
    void givenNonExistentId_whenGetOfferById_thenReturns404() throws Exception {
        mockMvc.perform(withGatewayAuth(
                        get("/v1/promotions/offers/{id}", UUID.fromString("00000000-0000-0000-0000-000000000001"))))
    ...
    void givenActiveOffer_whenDeactivate_thenReturns200WithInactiveStatus() throws Exception {
        ...
        mockMvc.perform(withGatewayAuth(patch("/v1/promotions/offers/{id}/deactivate", UUID.fromString(offerId))))
                .andExpect(status().isOk())
    ...
    @Test
    @DisplayName(
            "POC-011: PATCH /v1/promotions/offers/{id}/activate on EXPIRED offer → 422 PROMOTION_OFFER_INVALID_STATE")
    ...
    void getOfferById_withoutAuth_returns401() throws Exception {
        ...
        mockMvc.perform(get("/v1/promotions/offers/{id}", id)).andExpect(status().isUnauthorized());
    }
    ...
    void getOfferByCode_withoutAuth_returns401() throws Exception {
        mockMvc.perform(get("/v1/promotions/offers/by-code/SUMMER10")).andExpect(status().isUnauthorized());
    }
}
